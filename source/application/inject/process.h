...
{
public:
    ProcessMemoryException(const std::string& msg, LPVOID address)
        : std::runtime_error(msg), address_(address){};
    LPVOID getAddress()
    {
        return address_;
    };
...
{
public:
    MemoryProtectException(const std::string& msg, LPVOID address)
        : ProcessMemoryException(msg, address){};
};
