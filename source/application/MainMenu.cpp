...
void Build_Main_Menu(HMENU& MainMenu, HWND hWnd)
{
	...
	// Debug Log Submenu
	i = 0;
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::ANY)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_ANY, "", "Uncategorized", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::HOOK)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_HOOK, "", "Hooking", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::TIME)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_TIME, "", "Time", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::DETTIMER)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_DETTIMER, "", "Det. Timer", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::SYNC)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_SYNC, "", "Sync", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::DDRAW)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_DDRAW, "", "DirectDraw", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::D3D)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_D3D, "", "Direct3D", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::OGL)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_OGL, "", "OpenGL", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::GDI)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_GDI, "", "GDI", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::SDL)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_SDL, "", "SDL", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::DINPUT)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_DINPUT, "", "DirectInput", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::WINPUT)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_WINPUT, "", "Windows Input", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::XINPUT)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_XINPUT, "", "XInput", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::DSOUND)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_DSOUND, "", "DirectSound", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::WSOUND)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_WSOUND, "", "Windows Sound", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::PROCESS)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_PROCESS, "", "Process", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::MODULE)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_MODULE, "", "Module", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::MESSAGES)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_MESSAGES, "", "Messages", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::WINDOW)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_WINDOW, "", "Window", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::FILEIO)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_FILEIO, "", "File", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::REGISTRY)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_REGISTRY, "", "Registry", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::THREAD)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_THREAD, "", "Thread", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags | ((localTASflags.log_categories[static_cast<std::underlying_type<LogCategory>::type>(LogCategory::TIMERS)])?MF_CHECKED:MF_UNCHECKED), ID_INCLUDE_LCF_TIMERS, "", "Timers", 0);
	InsertMenu(DebugLogging, i++, MF_SEPARATOR, NULL, NULL);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags, ID_INCLUDE_LCF_ALL, "", "All", 0);
	HelperFuncInsertMenuByID(DebugLogging, i++, Flags, ID_INCLUDE_LCF_NONE, "", "None (uncategorized only)", 0);
