...
namespace Hooks
{
    ...
    HOOK_FUNCTION_DECLARE(LONG, WINAPI, SetWindowLongW, HWND hWnd, int nIndex, LONG dwNewLong);
    HOOK_FUNCTION_DECLARE(LONG, WINAPI, GetWindowLongA, HWND hWnd, int nIndex);
    HOOK_FUNCTION_DECLARE(LONG, WINAPI, GetWindowLongW, HWND hWnd, int nIndex);
    ...
    HOOK_FUNCTION_DECLARE(BOOL, WINAPI, ClientToScreen, HWND hWnd, LPPOINT lpPoint);
    HOOK_FUNCTION_DECLARE(BOOL, WINAPI, ScreenToClient, HWND hWnd, LPPOINT lpPoint);
    HOOK_FUNCTION_DECLARE(BOOL, WINAPI, SetWindowTextA, HWND hWnd, LPCSTR lpString);
    HOOK_FUNCTION_DECLARE(BOOL, WINAPI, SetWindowTextW, HWND hWnd, LPCWSTR lpString);

    HOOK_FUNCTION_DECLARE(HWND, WINAPI, GetActiveWindow);
    HOOK_FUNCTION_DECLARE(HWND, WINAPI, GetForegroundWindow);
    HOOK_FUNCTION_DECLARE(HWND, WINAPI, GetFocus);
