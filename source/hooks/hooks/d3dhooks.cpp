...
DEFINE_LOCAL_GUID(IID_IDirect3D,
                  0x3BBA0080,
                  0x2421,
                  0x11CF,
                  0xA3,
                  ...
                  0x33,
                  0x56); //version  < 0x0500
DEFINE_LOCAL_GUID(IID_IDirect3D2,
                  0x6aae1ec1,
                  0x662a,
                  0x11d0,
                  0x88,
                  ...
                  0xb7,
                  0x6a); //version >= 0x0500
DEFINE_LOCAL_GUID(IID_IDirect3D3,
                  0xbb223240,
                  0xe72b,
                  0x11d0,
                  0xa9,
                  ...
                  0x99,
                  0x3e); //version >= 0x0600
DEFINE_LOCAL_GUID(IID_IDirect3D7,
                  0xf5049e77,
                  0x4861,
                  0x11d2,
                  0xa4,
...
DEFINE_LOCAL_GUID(IID_IDirect3DDevice,
                  0x64108800,
                  0x957d,
                  0X11d0,
                  0x89,
                  ...
                  0x41,
                  0x29);
DEFINE_LOCAL_GUID(IID_IDirect3DDevice2,
                  0x93281501,
                  0x8cf8,
                  0x11d0,
                  0x89,
                  ...
                  0x41,
                  0x29);
DEFINE_LOCAL_GUID(IID_IDirect3DDevice3,
                  0xb0ab3b60,
                  0x33d7,
                  0x11d1,
                  0xa9,
                  ...
                  0xb1,
                  0x74);
DEFINE_LOCAL_GUID(IID_IDirect3DDevice7,
                  0xf5049e79,
                  0x4861,
                  0x11d2,
                  0xa4,
...
DEFINE_LOCAL_GUID(IID_IDirect3DRampDevice,
                  0xF2086B20,
                  0x259F,
                  0x11CF,
                  0xA3,
                  ...
                  0x33,
                  0x56);
DEFINE_LOCAL_GUID(IID_IDirect3DRGBDevice,
                  0xA4665C60,
                  0x2673,
                  0x11CF,
                  0xA3,
                  ...
                  0x33,
                  0x56);
DEFINE_LOCAL_GUID(IID_IDirect3DHALDevice,
                  0x84E63dE0,
                  0x46AA,
                  0x11CF,
                  0x81,
                  ...
                  0x15,
                  0x6E);
DEFINE_LOCAL_GUID(IID_IDirect3DMMXDevice,
                  0x881949a1,
                  0xd6f3,
                  0x11d0,
                  0x89,
                  ...
                  0x41,
                  0x29);
DEFINE_LOCAL_GUID(IID_IDirect3DRefDevice,
                  0x50936643,
                  0x13e9,
                  0x11d1,
                  0x89,
                  ...
                  0x41,
                  0x29);
DEFINE_LOCAL_GUID(IID_IDirect3DNullDevice,
                  0x8767df22,
                  0xbacc,
                  0x11d1,
                  0x89,
                  ...
                  0x29,
                  0xa8);
DEFINE_LOCAL_GUID(IID_IDirect3DTnLHalDevice,
                  0xf5049e78,
                  0x4861,
                  0x11d2,
                  0xa4,
...
namespace Hooks
{
    ...
    struct IDirect3DTraits
    {
    };
    template<>
    struct IDirect3DTraits<IDirect3D>
    {
        typedef IDirect3DDevice DIRECT3DDEVICEN;
        typedef LPDIRECT3DDEVICE LPDIRECT3DDEVICEN;
        typedef LPDIRECTDRAWSURFACE LPDIRECTDRAWSURFACEN;
    ...
    template<>
    struct IDirect3DTraits<IDirect3D2>
    {
        typedef IDirect3DDevice2 DIRECT3DDEVICEN;
        typedef LPDIRECT3DDEVICE2 LPDIRECT3DDEVICEN;
        typedef LPDIRECTDRAWSURFACE LPDIRECTDRAWSURFACEN;
        typedef IDirectDrawSurface DIRECTDRAWSURFACEN;
        enum
        {
    ...
    template<>
    struct IDirect3DTraits<IDirect3D3>
    {
        typedef IDirect3DDevice3 DIRECT3DDEVICEN;
        typedef LPDIRECT3DDEVICE3 LPDIRECT3DDEVICEN;
        typedef LPDIRECTDRAWSURFACE4 LPDIRECTDRAWSURFACEN;
    ...
    template<>
    struct IDirect3DTraits<IDirect3D7>
    {
        typedef IDirect3DDevice7 DIRECT3DDEVICEN;
        typedef LPDIRECT3DDEVICE7 LPDIRECT3DDEVICEN;
        typedef LPDIRECTDRAWSURFACE7 LPDIRECTDRAWSURFACEN;
    ...
    public:
        ...
        static HRESULT(STDMETHODCALLTYPE* QueryInterface)(IDirect3DN* pThis,
                                                          REFIID riid,
                                                          void** ppvObj);
        static HRESULT STDMETHODCALLTYPE MyQueryInterface(IDirect3DN* pThis,
                                                          REFIID riid,
                                                          void** ppvObj)
        {
        ...
        static HRESULT(STDMETHODCALLTYPE* CreateDevice)(IDirect3DN* pThis,
                                                        REFCLSID rguid,
                                                        LPDIRECTDRAWSURFACEN surf,
                                                        LPDIRECT3DDEVICEN* device);
        static HRESULT STDMETHODCALLTYPE MyCreateDevice(IDirect3DN* pThis,
                                                        REFCLSID rguid,
                                                        LPDIRECTDRAWSURFACEN surf,
                                                        LPDIRECT3DDEVICEN* device)
        {
        ...
        static HRESULT(STDMETHODCALLTYPE* CreateDevice3)(IDirect3DN* pThis,
                                                         REFCLSID rguid,
                                                         LPDIRECTDRAWSURFACEN surf,
                                                         LPDIRECT3DDEVICEN* device,
                                                         LPUNKNOWN stupidPointlessArgument);
        static HRESULT STDMETHODCALLTYPE MyCreateDevice3(IDirect3DN* pThis,
                                                         REFCLSID rguid,
                                                         LPDIRECTDRAWSURFACEN surf,
                                                         LPDIRECT3DDEVICEN* device,
                                                         LPUNKNOWN stupidPointlessArgument)
    ...
    template<>
    BOOL MyDirect3D<IDirect3D>::Hook(IDirect3D* obj)
    {
        BOOL rv = FALSE;
    ...
    template<>
    BOOL MyDirect3D<IDirect3D3>::Hook(IDirect3D3* obj)
    {
        BOOL rv = FALSE;
    ...
    template<>
    const GUID MyDirect3D<IDirect3D>::deviceGuid = IID_IDirect3DDevice;
    template<>
    const GUID MyDirect3D<IDirect3D2>::deviceGuid = IID_IDirect3DDevice2;
    template<>
    const GUID MyDirect3D<IDirect3D3>::deviceGuid = IID_IDirect3DDevice3;
    template<>
    const GUID MyDirect3D<IDirect3D7>::deviceGuid = IID_IDirect3DDevice7;
    template<>
    const GUID MyDirect3D<IDirect3D>::curGuid = IID_IDirect3D;
    template<>
    const GUID MyDirect3D<IDirect3D2>::curGuid = IID_IDirect3D2;
    template<>
    const GUID MyDirect3D<IDirect3D3>::curGuid = IID_IDirect3D3;
    template<>
    const GUID MyDirect3D<IDirect3D7>::curGuid = IID_IDirect3D7;
...
#define DEF(x)                                                                              \
    template<>                                                                              \
    HRESULT(STDMETHODCALLTYPE* MyDirect3D<x>::QueryInterface)                               \
    (x * pThis, REFIID riid, void** ppvObj) = 0;                                            \
    template<>                                                                              \
    HRESULT(STDMETHODCALLTYPE* MyDirect3D<x>::CreateDevice)                                 \
    (x * pThis, REFCLSID rguid, LPDIRECTDRAWSURFACEN surf, LPDIRECT3DDEVICEN * device) = 0; \
    template<>                                                                              \
    HRESULT(STDMETHODCALLTYPE* MyDirect3D<x>::CreateDevice3)                                \
    (x * pThis,                                                                             \
     REFCLSID rguid,                                                                        \
     LPDIRECTDRAWSURFACEN surf,                                                             \
     LPDIRECT3DDEVICEN * device,                                                            \
     LPUNKNOWN stupidPointlessArgument) = 0;
...
#undef HRESULT
    ...
    struct IDirect3DDeviceTraits
    {
    };
    template<>
    struct IDirect3DDeviceTraits<IDirect3DDevice>
    {
        typedef LPDIRECT3DVERTEXBUFFER LPDIRECT3DVERTEXBUFFERN;
    };
    template<>
    struct IDirect3DDeviceTraits<IDirect3DDevice2>
    {
        typedef LPDIRECT3DVERTEXBUFFER LPDIRECT3DVERTEXBUFFERN;
    };
    template<>
    struct IDirect3DDeviceTraits<IDirect3DDevice3>
    {
        typedef LPDIRECT3DVERTEXBUFFER LPDIRECT3DVERTEXBUFFERN;
    };
    template<>
    struct IDirect3DDeviceTraits<IDirect3DDevice7>
    {
        typedef LPDIRECT3DVERTEXBUFFER7 LPDIRECT3DVERTEXBUFFERN;
    };

    template<typename IDirect3DDeviceN>
    struct MyDirect3DDevice
    {
        typedef typename IDirect3DDeviceTraits<IDirect3DDeviceN>::LPDIRECT3DVERTEXBUFFERN
            LPDIRECT3DVERTEXBUFFERN;
        ...
        static HRESULT(STDMETHODCALLTYPE* QueryInterface)(IDirect3DDeviceN* pThis,
                                                          REFIID riid,
                                                          void** ppvObj);
        static HRESULT STDMETHODCALLTYPE MyQueryInterface(IDirect3DDeviceN* pThis,
                                                          REFIID riid,
                                                          void** ppvObj)
        {
            ENTER(pThis);
        ...
        static HRESULT(STDMETHODCALLTYPE* DrawPrimitive)(IDirect3DDeviceN* pThis,
                                                         D3DPRIMITIVETYPE a,
                                                         DWORD b,
                                                         LPVOID c,
                                                         DWORD d,
                                                         DWORD e);
        static HRESULT STDMETHODCALLTYPE MyDrawPrimitive(IDirect3DDeviceN* pThis,
                                                         D3DPRIMITIVETYPE a,
                                                         DWORD b,
                                                         LPVOID c,
                                                         DWORD d,
        ...
        static HRESULT(STDMETHODCALLTYPE* DrawIndexedPrimitive)(IDirect3DDeviceN* pThis,
                                                                D3DPRIMITIVETYPE a,
                                                                DWORD b,
                                                                LPVOID c,
                                                                DWORD d,
                                                                ...
                                                                DWORD f,
                                                                DWORD g);
        static HRESULT STDMETHODCALLTYPE MyDrawIndexedPrimitive(IDirect3DDeviceN* pThis,
                                                                D3DPRIMITIVETYPE a,
                                                                DWORD b,
                                                                LPVOID c,
                                                                DWORD d,
        ...
        static HRESULT(STDMETHODCALLTYPE* DrawPrimitiveStrided)(IDirect3DDeviceN* pThis,
                                                                D3DPRIMITIVETYPE a,
                                                                DWORD b,
                                                                LPD3DDRAWPRIMITIVESTRIDEDDATA c,
                                                                DWORD d,
                                                                DWORD e);
        static HRESULT STDMETHODCALLTYPE MyDrawPrimitiveStrided(IDirect3DDeviceN* pThis,
                                                                D3DPRIMITIVETYPE a,
                                                                DWORD b,
                                                                LPD3DDRAWPRIMITIVESTRIDEDDATA c,
                                                                DWORD d,
        ...
        static HRESULT(STDMETHODCALLTYPE* DrawIndexedPrimitiveStrided)(
            IDirect3DDeviceN* pThis,
            D3DPRIMITIVETYPE a,
            DWORD b,
            LPD3DDRAWPRIMITIVESTRIDEDDATA c,
            DWORD d,
        ...
        MyDrawIndexedPrimitiveStrided(IDirect3DDeviceN* pThis,
                                      D3DPRIMITIVETYPE a,
                                      DWORD b,
                                      LPD3DDRAWPRIMITIVESTRIDEDDATA c,
                                      DWORD d,
        ...
        static HRESULT(STDMETHODCALLTYPE* DrawPrimitiveVB)(IDirect3DDeviceN* pThis,
                                                           D3DPRIMITIVETYPE a,
                                                           LPDIRECT3DVERTEXBUFFERN b,
                                                           DWORD c,
                                                           DWORD d,
                                                           DWORD e);
        static HRESULT STDMETHODCALLTYPE MyDrawPrimitiveVB(IDirect3DDeviceN* pThis,
                                                           D3DPRIMITIVETYPE a,
                                                           LPDIRECT3DVERTEXBUFFERN b,
                                                           DWORD c,
                                                           DWORD d,
        ...
        static HRESULT(STDMETHODCALLTYPE* DrawIndexedPrimitiveVB)(IDirect3DDeviceN* pThis,
                                                                  D3DPRIMITIVETYPE a,
                                                                  LPDIRECT3DVERTEXBUFFERN b,
                                                                  DWORD c,
                                                                  DWORD d,
                                                                  ...
                                                                  DWORD f,
                                                                  DWORD g);
        static HRESULT STDMETHODCALLTYPE MyDrawIndexedPrimitiveVB(IDirect3DDeviceN* pThis,
                                                                  D3DPRIMITIVETYPE a,
                                                                  LPDIRECT3DVERTEXBUFFERN b,
                                                                  DWORD c,
                                                                  DWORD d,
        ...
        static HRESULT(STDMETHODCALLTYPE* Begin)(IDirect3DDeviceN* pThis,
                                                 D3DPRIMITIVETYPE a,
                                                 D3DVERTEXTYPE b,
                                                 DWORD c);
        static HRESULT STDMETHODCALLTYPE MyBegin(IDirect3DDeviceN* pThis,
                                                 D3DPRIMITIVETYPE a,
                                                 D3DVERTEXTYPE b,
                                                 DWORD c)
        {
        ...
        static HRESULT(STDMETHODCALLTYPE* BeginIndexed)(IDirect3DDeviceN* pThis,
                                                        D3DPRIMITIVETYPE a,
                                                        D3DVERTEXTYPE b,
                                                        LPVOID c,
                                                        DWORD d,
                                                        DWORD e);
        static HRESULT STDMETHODCALLTYPE MyBeginIndexed(IDirect3DDeviceN* pThis,
                                                        D3DPRIMITIVETYPE a,
                                                        D3DVERTEXTYPE b,
                                                        LPVOID c,
                                                        DWORD d,
        ...
        static HRESULT(STDMETHODCALLTYPE* Clear)(IDirect3DDeviceN* pThis,
                                                 DWORD a,
                                                 LPD3DRECT b,
                                                 DWORD c,
                                                 D3DCOLOR d,
                                                 D3DVALUE e,
                                                 DWORD f);
        static HRESULT STDMETHODCALLTYPE MyClear(IDirect3DDeviceN* pThis,
                                                 DWORD a,
                                                 LPD3DRECT b,
                                                 DWORD c,
                                                 D3DCOLOR d,
    ...
    template<>
    BOOL MyDirect3DDevice<IDirect3DDevice>::Hook(IDirect3DDevice* obj)
    {
        BOOL rv = FALSE;
    ...
    template<>
    BOOL MyDirect3DDevice<IDirect3DDevice2>::Hook(IDirect3DDevice2* obj)
    {
        BOOL rv = FALSE;
    ...
    template<>
    BOOL MyDirect3DDevice<IDirect3DDevice3>::Hook(IDirect3DDevice3* obj)
    {
        BOOL rv = FALSE;
...
#define DEF(x)                                                                                   \
    template<>                                                                                   \
    ULONG(STDMETHODCALLTYPE* MyDirect3DDevice<x>::Release)                                       \
    (x * pThis) = 0;                                                                             \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::QueryInterface)                              \
    (x * pThis, REFIID riid, void** ppvObj) = 0;                                                 \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::BeginScene)                                  \
    (x * pThis) = 0;                                                                             \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::EndScene)                                    \
    (x * pThis) = 0;                                                                             \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::DrawPrimitive)                               \
    (x * pThis, D3DPRIMITIVETYPE a, DWORD b, LPVOID c, DWORD d, DWORD e) = 0;                    \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::DrawIndexedPrimitive)                        \
    (x * pThis, D3DPRIMITIVETYPE a, DWORD b, LPVOID c, DWORD d, LPWORD e, DWORD f, DWORD g) = 0; \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::DrawPrimitiveStrided)                        \
    (x * pThis, D3DPRIMITIVETYPE a, DWORD b, LPD3DDRAWPRIMITIVESTRIDEDDATA c, DWORD d, DWORD e); \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::DrawIndexedPrimitiveStrided)                 \
    (x * pThis,                                                                                  \
     D3DPRIMITIVETYPE a,                                                                         \
     DWORD b,                                                                                    \
     LPD3DDRAWPRIMITIVESTRIDEDDATA c,                                                            \
     ...
     DWORD g);                                                                                   \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::DrawPrimitiveVB)                             \
    (x * pThis, D3DPRIMITIVETYPE a, LPDIRECT3DVERTEXBUFFERN b, DWORD c, DWORD d, DWORD e);       \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::DrawIndexedPrimitiveVB)                      \
    (x * pThis,                                                                                  \
     D3DPRIMITIVETYPE a,                                                                         \
     LPDIRECT3DVERTEXBUFFERN b,                                                                  \
     DWORD c,                                                                                    \
     ...
     DWORD g);                                                                                   \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::Begin)                                       \
    (x * pThis, D3DPRIMITIVETYPE, D3DVERTEXTYPE, DWORD);                                         \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::BeginIndexed)                                \
    (x * pThis, D3DPRIMITIVETYPE, D3DVERTEXTYPE, LPVOID, DWORD, DWORD);                          \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::Vertex)                                      \
    (x * pThis, LPVOID);                                                                         \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::Index)                                       \
    (x * pThis, WORD);                                                                           \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::End)                                         \
    (x * pThis, DWORD);                                                                          \
    template<>                                                                                   \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice<x>::Clear)                                       \
    (x * pThis, DWORD a, LPD3DRECT b, DWORD c, D3DCOLOR d, D3DVALUE e, DWORD f);
...
#undef HRESULT
    ...
    HOOK_FUNCTION(HRESULT,
                  ...
                  LPUNKNOWN* lplpd3d,
                  LPUNKNOWN pUnkOuter);
    HOOKFUNC HRESULT WINAPI MyDirect3DCreate(UINT SDKVersion,
                                             LPUNKNOWN* lplpd3d,
                                             LPUNKNOWN pUnkOuter)
    {
        ENTER(SDKVersion);
    ...
    HOOK_FUNCTION(HRESULT,
                  ...
                  LPUNKNOWN* lplpd3d,
                  LPUNKNOWN pUnkOuter);
    HOOKFUNC HRESULT WINAPI MyDirect3DCreate7(UINT SDKVersion,
                                              LPUNKNOWN* lplpd3d,
                                              LPUNKNOWN pUnkOuter)
    {
        ENTER(SDKVersion);
    ...
    HOOK_FUNCTION(HRESULT,
                  ...
                  LPUNKNOWN pUnkOuter);
    HOOKFUNC HRESULT WINAPI MyDirect3DCreateDevice(GUID FAR* lpGUID,
                                                   LPUNKNOWN lpd3ddevice,
                                                   LPDIRECTDRAWSURFACE surf,
                                                   LPUNKNOWN* lplpd3ddevice,
                                                   LPUNKNOWN pUnkOuter)
    ...
    HOOK_FUNCTION(HRESULT,
                  ...
                  LPUNKNOWN* lplpd3ddevice,
                  LPUNKNOWN pUnkOuter);
    HOOKFUNC HRESULT WINAPI MyDirect3DCreateDevice7(GUID FAR* lpGUID,
                                                    LPUNKNOWN lpd3ddevice,
                                                    LPDIRECTDRAWSURFACE surf,
                                                    LPUNKNOWN* lplpd3ddevice,
                                                    LPUNKNOWN pUnkOuter)
