...
DEFINE_LOCAL_GUID(IID_IDirectDraw,
                  0x6C14DB80,
                  0xA733,
                  0x11CE,
                  0xA5,
                  ...
                  0xE5,
                  0x60);
DEFINE_LOCAL_GUID(IID_IDirectDraw2,
                  0xB3A6F3E0,
                  0x2B43,
                  0x11CF,
                  0xA2,
                  ...
                  0x33,
                  0x56);
DEFINE_LOCAL_GUID(IID_IDirectDraw4,
                  0x9c59509a,
                  0x39bd,
                  0x11d1,
                  0x8c,
                  ...
                  0x30,
                  0xc5);
DEFINE_LOCAL_GUID(IID_IDirectDraw7,
                  0x15e65ec0,
                  0x3b9c,
                  0x11d2,
                  0xb9,
...
DEFINE_LOCAL_GUID(IID_IDirectDrawSurface,
                  0x6C14DB81,
                  0xA733,
                  0x11CE,
                  0xA5,
                  ...
                  0xE5,
                  0x60);
DEFINE_LOCAL_GUID(IID_IDirectDrawSurface2,
                  0x57805885,
                  0x6EEC,
                  0x11CF,
                  0x94,
                  ...
                  0x0E,
                  0x27);
DEFINE_LOCAL_GUID(IID_IDirectDrawSurface3,
                  0xDA044E00,
                  0x69B2,
                  0x11D0,
                  0xA1,
                  ...
                  0xDF,
                  0xBB);
DEFINE_LOCAL_GUID(IID_IDirectDrawSurface4,
                  0x0B2B8630,
                  0xAD35,
                  0x11D0,
                  0x8E,
                  ...
                  0xEA,
                  0x5B);
DEFINE_LOCAL_GUID(IID_IDirectDrawSurface7,
                  0x06675A80,
                  0x3B9B,
                  0x11D2,
                  0xB9,
...
DEFINE_LOCAL_GUID(IID_IDirectDrawGammaControl,
                  0x69C11C3E,
                  0xB46B,
                  0x11D1,
                  0xAD,
...
namespace Hooks
{
    ...
    struct IDirectDrawTraits
    {
    };
    template<>
    struct IDirectDrawTraits<IDirectDraw>
    {
        typedef IDirectDrawSurface DIRECTDRAWSURFACEN;
        typedef DDSURFACEDESC DDSURFACEDESCN;
        typedef DDSCAPS DDSCAPSN;
        typedef DDDEVICEIDENTIFIER DDDEVICEIDENTIFIERN;
        enum
        {
            NUMBER = 1
        };
    ...
    template<>
    struct IDirectDrawTraits<IDirectDraw2>
    {
        typedef IDirectDrawSurface DIRECTDRAWSURFACEN;
        typedef DDSURFACEDESC DDSURFACEDESCN;
        typedef DDSCAPS DDSCAPSN;
    ...
    template<>
    struct IDirectDrawTraits<IDirectDraw4>
    {
        typedef IDirectDrawSurface4 DIRECTDRAWSURFACEN;
        typedef DDSURFACEDESC2 DDSURFACEDESCN;
        typedef DDSCAPS2 DDSCAPSN;
        typedef DDDEVICEIDENTIFIER DDDEVICEIDENTIFIERN;
        enum
        {
            NUMBER = 4
    ...
    template<>
    struct IDirectDrawTraits<IDirectDraw7>
    {
        typedef IDirectDrawSurface7 DIRECTDRAWSURFACEN;
        typedef DDSURFACEDESC2 DDSURFACEDESCN;
        typedef DDSCAPS2 DDSCAPSN;
        typedef DDDEVICEIDENTIFIER2 DDDEVICEIDENTIFIERN;
        enum
        {
            NUMBER = 7
        };
    ...
    struct IDirectDrawSurfaceTraits
    {
    };
    template<>
    struct IDirectDrawSurfaceTraits<IDirectDrawSurface>
    {
        typedef IDirectDrawSurface DIRECTDRAWSURFACEN;
        typedef DDSURFACEDESC DDSURFACEDESCN;
        typedef DDSCAPS DDSCAPSN;
        typedef LPVOID UNLOCKARG;
        typedef HRESULT(FAR PASCAL* LPDDENUMSURFACESCALLBACKN)(LPDIRECTDRAWSURFACE,
                                                               LPDDSURFACEDESC,
                                                               LPVOID);
        enum
        {
    ...
    template<>
    struct IDirectDrawSurfaceTraits<IDirectDrawSurface2>
    {
        typedef IDirectDrawSurface2 DIRECTDRAWSURFACEN;
        typedef DDSURFACEDESC DDSURFACEDESCN;
        typedef DDSCAPS DDSCAPSN;
        typedef LPVOID UNLOCKARG;
        typedef HRESULT(FAR PASCAL* LPDDENUMSURFACESCALLBACKN)(LPDIRECTDRAWSURFACE,
    ...
    template<>
    struct IDirectDrawSurfaceTraits<IDirectDrawSurface3>
    {
        typedef IDirectDrawSurface3 DIRECTDRAWSURFACEN;
        typedef DDSURFACEDESC DDSURFACEDESCN;
        typedef DDSCAPS DDSCAPSN;
        typedef LPVOID UNLOCKARG;
        typedef HRESULT(FAR PASCAL* LPDDENUMSURFACESCALLBACKN)(LPDIRECTDRAWSURFACE,
    ...
    template<>
    struct IDirectDrawSurfaceTraits<IDirectDrawSurface4>
    {
        typedef IDirectDrawSurface4 DIRECTDRAWSURFACEN;
        typedef DDSURFACEDESC2 DDSURFACEDESCN;
        typedef DDSCAPS2 DDSCAPSN;
        typedef LPRECT UNLOCKARG;
        typedef HRESULT(FAR PASCAL* LPDDENUMSURFACESCALLBACKN)(LPDIRECTDRAWSURFACE4,
                                                               LPDDSURFACEDESC2,
                                                               LPVOID);
        enum
        {
    ...
    template<>
    struct IDirectDrawSurfaceTraits<IDirectDrawSurface7>
    {
        typedef IDirectDrawSurface7 DIRECTDRAWSURFACEN;
        typedef DDSURFACEDESC2 DDSURFACEDESCN;
        typedef DDSCAPS2 DDSCAPSN;
        typedef LPRECT UNLOCKARG;
        typedef HRESULT(FAR PASCAL* LPDDENUMSURFACESCALLBACKN)(LPDIRECTDRAWSURFACE7,
                                                               LPDDSURFACEDESC2,
                                                               LPVOID);
        enum
        {
    ...
    {
        typedef typename IDirectDrawSurfaceTraits<IDirectDrawSurfaceN>::DIRECTDRAWSURFACEN
            DIRECTDRAWSURFACEN;
        typedef
            typename IDirectDrawSurfaceTraits<IDirectDrawSurfaceN>::DDSURFACEDESCN DDSURFACEDESCN;
        typedef typename IDirectDrawSurfaceTraits<IDirectDrawSurfaceN>::DDSCAPSN DDSCAPSN;
        typedef typename IDirectDrawSurfaceTraits<IDirectDrawSurfaceN>::LPDDENUMSURFACESCALLBACKN
            LPDDENUMSURFACESCALLBACKN;
        ...
        static BOOL Hook(DIRECTDRAWSURFACEN* obj)
        {
            ...
            if (s_hookAttachPass)
            {
                ...
                attachedSurfaces[obj] =
                    (DIRECTDRAWSURFACEN*) s_hookAttachPass; // TODO: wrong type, does it matter?
            }
        ...
        static HRESULT(STDMETHODCALLTYPE* QueryInterface)(DIRECTDRAWSURFACEN* pThis,
                                                          REFIID riid,
                                                          void** ppvObj);
        static HRESULT STDMETHODCALLTYPE MyQueryInterface(DIRECTDRAWSURFACEN* pThis,
                                                          REFIID riid,
                                                          void** ppvObj)
        {
            ENTER(riid.Data1);
        ...
        static void HandleNewFrame(int xOrigin,
                                   int yOrigin,
                                   DIRECTDRAWSURFACEN* pThis,
                                   DIRECTDRAWSURFACEN* pSource,
                                   RECT* destRect,
                                   RECT* srcRect)
        {
            usingSDLOrDD = true;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (!info.ddrawInterface)
                            info = s_ddrawSurfaceToOwner
                                [pSource]; // needed in fake fullscreen? at least in la-mulana
                    ...
                    if (pSurface != pBackBuffer)
                        if (!pSurface
                            || FAILED(BltFast(pSurface, 0, 0, pBackBuffer, NULL, DDBLTFAST_WAIT)))
                    ...
                    pSurface->Lock(NULL,
                                   &desc,
                                   DDLOCK_SURFACEMEMORYPTR | DDLOCK_WAIT | DDLOCK_READONLY,
                                   NULL);
                    FrameBoundary(&desc, CAPTUREINFO_TYPE_DDSD);
        ...
        static HRESULT(STDMETHODCALLTYPE* Blt)(DIRECTDRAWSURFACEN* pThis,
                                               LPRECT destRect,
                                               DIRECTDRAWSURFACEN* pSource,
                                               LPRECT srcRect,
                                               DWORD flags,
                                               LPDDBLTFX bltfx);
        static HRESULT STDMETHODCALLTYPE MyBlt(DIRECTDRAWSURFACEN* pThis,
                                               LPRECT destRect,
                                               DIRECTDRAWSURFACEN* pSource,
                                               LPRECT srcRect,
                                               DWORD flags,
                                               LPDDBLTFX bltfx)
        {
            ...
            GetCaps(pThis, &caps);
            bool destIsPrimary =
                (caps.dwCaps & (DDSCAPS_PRIMARYSURFACE | DDSCAPS_FRONTBUFFER)) != 0;
            ...
            if (srcIsPrimary || destIsPrimary)
            {
                ...
                RECT realRect;
                if (GetClientRect(gamehwnd, &realRect)
                    && ClientToScreen(gamehwnd, (LPPOINT) &realRect.left)
                    && ClientToScreen(gamehwnd, (LPPOINT) &realRect.right))
                {
                    DDSURFACEDESCN ddsdBB = {sizeof(DDSURFACEDESCN)};
                    if (!s_theBackBuffer
                        || FAILED(GetSurfaceDesc((DIRECTDRAWSURFACEN*) s_theBackBuffer, &ddsdBB)))
                    {
                    ...
                    if (destIsPrimary)
                    {
                        if (!destRect)
                        {
                            ...
                            destRect =
                                &tempDstRect; // avoid altering original rect, since the game owns it
                            *destRect = realRect;
                        }
                    ...
                    if (srcIsPrimary)
                    {
                        if (!srcRect)
                        {
                            ...
                            srcRect =
                                &tempSrcRect; // avoid altering original rect, since the game owns it
                            *srcRect = realRect;
                        }
                        else if (fakeDisplayValid)
                        {
            ...
            else
            {
                ...
                if (!destIsPrimary)
                    ...
                    pSource) // catch the case where the back buffer changes but is never blitted to:
        ...
        static HRESULT(STDMETHODCALLTYPE* BltFast)(DIRECTDRAWSURFACEN* pThis,
                                                   DWORD xDest,
                                                   DWORD yDest,
                                                   DIRECTDRAWSURFACEN* pSource,
                                                   LPRECT srcRect,
                                                   DWORD flags);
        static HRESULT STDMETHODCALLTYPE MyBltFast(DIRECTDRAWSURFACEN* pThis,
                                                   DWORD xDest,
                                                   DWORD yDest,
                                                   DIRECTDRAWSURFACEN* pSource,
                                                   LPRECT srcRect,
            ...
            else
            {
                if (!destIsPrimary)
                {
                    ...
                    if (pSource)
                    {
                        ...
                        GetCaps(pSource, &caps2);
                        if ((caps2.dwCaps
                             & (DDSCAPS_PRIMARYSURFACE | DDSCAPS_FRONTBUFFER))) // srcIsPrimary?
                        {
                            if (tasflags.forceWindowed && s_theBackBuffer)
                            {
                                ...
                                RECT bbRect = {0,
                                               0,
                                               static_cast<LONG>(ddsdBB.dwWidth),
                                               static_cast<LONG>(ddsdBB.dwHeight)};
                                static RECT rect;
                                rect = bbRect;
                                POINT pt = {0, 0};
                                if (ClientToScreen(gamehwnd, &pt) && OffsetRect(&rect, pt.x, pt.y))
                                {
                                    if (!srcRect
                                        || (fakeDisplayValid
                                            && (int) (srcRect->right - xDest) >= fakeDisplayWidth
                                            && (int) (srcRect->bottom - yDest)
                                                   >= fakeDisplayHeight))
                                    {
                                        srcRect = &rect;
                                    }
                ...
                else
                {
                    ...
                    if (!srcRect)
                    {
                        ...
                        if (pSource)
                        {
                            ...
                            {
                                RECT destRect = {static_cast<LONG>(xDest),
                                                 static_cast<LONG>(yDest),
                                                 static_cast<LONG>(xDest + ddsdesc.dwWidth),
                                                 static_cast<LONG>(yDest + ddsdesc.dwHeight)};
                        ...
                        if (SUCCEEDED(GetSurfaceDesc(pThis, &ddsdesc)))
                        {
                            RECT destRect = {static_cast<LONG>(xDest),
                                             static_cast<LONG>(yDest),
                                             static_cast<LONG>(ddsdesc.dwWidth),
                                             static_cast<LONG>(ddsdesc.dwHeight)};
                            return MyBlt(pThis, &destRect, pSource, srcRect, 0, NULL);
                        }
                        return MyBlt(pThis, NULL, pSource, NULL, 0, NULL);
                    }
                    RECT destRect = {static_cast<LONG>(xDest),
                                     static_cast<LONG>(yDest),
                                     static_cast<LONG>(xDest + srcRect->right - srcRect->left),
                                     static_cast<LONG>(yDest + srcRect->bottom - srcRect->top)};
                    return MyBlt(pThis, &destRect, pSource, srcRect, 0, NULL);
                }
            }
        ...
        static HRESULT(STDMETHODCALLTYPE* BltBatch)(DIRECTDRAWSURFACEN* pThis,
                                                    LPDDBLTBATCH a,
                                                    DWORD b,
                                                    DWORD c);
        static HRESULT STDMETHODCALLTYPE MyBltBatch(DIRECTDRAWSURFACEN* pThis,
                                                    LPDDBLTBATCH a,
                                                    DWORD b,
                                                    DWORD c)
        {
        ...
        static HRESULT(STDMETHODCALLTYPE* GetSurfaceDesc)(DIRECTDRAWSURFACEN* pThis,
                                                          DDSURFACEDESCN* lpddsdesc);
        static HRESULT STDMETHODCALLTYPE MyGetSurfaceDesc(DIRECTDRAWSURFACEN* pThis,
                                                          DDSURFACEDESCN* lpddsdesc)
        {
        ...
        static HRESULT(STDMETHODCALLTYPE* GetPixelFormat)(DIRECTDRAWSURFACEN* pThis,
                                                          LPDDPIXELFORMAT lpddpfmt);
        static HRESULT STDMETHODCALLTYPE MyGetPixelFormat(DIRECTDRAWSURFACEN* pThis,
                                                          LPDDPIXELFORMAT lpddpfmt)
        {
        ...
        static HRESULT(STDMETHODCALLTYPE* Flip)(DIRECTDRAWSURFACEN* pThis,
                                                DIRECTDRAWSURFACEN* pOther,
                                                DWORD flags);
        static HRESULT STDMETHODCALLTYPE MyFlip(DIRECTDRAWSURFACEN* pThis,
                                                DIRECTDRAWSURFACEN* pOther,
                                                DWORD flags)
        {
            ENTER(pThis);
        ...
        static HRESULT(STDMETHODCALLTYPE* Lock)(DIRECTDRAWSURFACEN* pThis,
                                                LPRECT a,
                                                DDSURFACEDESCN* b,
                                                DWORD lockFlags,
                                                HANDLE d);
        static HRESULT STDMETHODCALLTYPE
        MyLock(DIRECTDRAWSURFACEN* pThis, LPRECT a, DDSURFACEDESCN* b, DWORD lockFlags, HANDLE d)
        {
            HRESULT rv;
        ...
        static HRESULT(STDMETHODCALLTYPE* SetPalette)(DIRECTDRAWSURFACEN* pThis,
                                                      LPDIRECTDRAWPALETTE pPalette);
        static HRESULT STDMETHODCALLTYPE MySetPalette(DIRECTDRAWSURFACEN* pThis,
                                                      LPDIRECTDRAWPALETTE pPalette)
        {
            ENTER();
        ...
        static HRESULT(STDMETHODCALLTYPE* SetColorKey)(DIRECTDRAWSURFACEN* pThis,
                                                       DWORD dwFlags,
                                                       LPDDCOLORKEY pKey);
        static HRESULT STDMETHODCALLTYPE MySetColorKey(DIRECTDRAWSURFACEN* pThis,
                                                       DWORD dwFlags,
                                                       LPDDCOLORKEY pKey)
        {
            ENTER(dwFlags, pKey);
        ...
        static HRESULT(STDMETHODCALLTYPE* GetAttachedSurface)(DIRECTDRAWSURFACEN* pThis,
                                                              DDSCAPSN* lpddscaps,
                                                              DIRECTDRAWSURFACEN** ppsurf);
        static HRESULT STDMETHODCALLTYPE MyGetAttachedSurface(DIRECTDRAWSURFACEN* pThis,
                                                              DDSCAPSN* lpddscaps,
                                                              DIRECTDRAWSURFACEN** ppsurf)
        {
            ENTER(lpddscaps);
        ...
        static void BackupVideoMemory(DIRECTDRAWSURFACEN* pThis)
        {
            ...
            if (SUCCEEDED(GetCaps(pThis, &desc.ddsCaps)))
            {
                    ...
                    && !(desc.ddsCaps.dwCaps & (DDSCAPS_PRIMARYSURFACE | DDSCAPS_FRONTBUFFER)))
                {
                    ...
                    if (SUCCEEDED(Lock(pThis,
                                       NULL,
                                       &desc,
                                       DDLOCK_WAIT | DDLOCK_READONLY | DDLOCK_NOSYSLOCK,
                                       NULL)))
                    {
                        ...
                        Unlock(pThis, NULL);
                        LOG() << "videoMemoryPixelBackup[" << pThis << "] is " << pixels
                              << ", size=" << size;
                        // ENTER(pThis);
                    }
                }
        ...
        static void RestoreVideoMemoryOfAllSurfaces()
        {
            ...
            for (iter = videoMemoryPixelBackup.begin(); iter != videoMemoryPixelBackup.end();
                 iter++)
                if (iter->second)
        ...
        static void BackupVideoMemoryOfAllSurfaces()
        {
            ...
            for (iter = videoMemoryBackupDirty.begin(); iter != videoMemoryBackupDirty.end();
                 iter++)
                if (iter->second)
                    BackupVideoMemory(iter->first);
        }

        static void CreateSysMemSurfaceB(DIRECTDRAWSURFACEN*& pDest,
                                         DIRECTDRAWSURFACEN* pSource,
                                         IDirectDrawOwnerInfo& ownerInfo,
                                         DDSURFACEDESCN& ddsd)
        {
        ...
        static DIRECTDRAWSURFACEN* CreateSysMemSurface(DIRECTDRAWSURFACEN* pSource,
                                                       IDirectDrawOwnerInfo ownerInfo)
        {
        ...
        static std::map<IDirectDrawSurfaceN*, IDirectDrawSurfaceN*>
...
#define HRESULT \
    long // some versions of visual studio (including 2008) don't understand "typedef long HRESULT;" (the compiler claims HRESULT is an undefined type even after it's typedef'd to long)

#define DEF(x)                                                                                                                                  \
    template<>                                                                                                                                  \
    ULONG(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::Release)                                                                                   \
    (x * pThis) = 0;                                                                                                                            \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::QueryInterface)                                                                          \
    (x * pThis, REFIID riid, void** ppvObj) = 0;                                                                                                \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::Blt)                                                                                     \
    (x * pThis, LPRECT a, DIRECTDRAWSURFACEN * b, LPRECT c, DWORD d, LPDDBLTFX e) = 0;                                                          \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::BltFast)                                                                                 \
    (x * pThis, DWORD a, DWORD b, DIRECTDRAWSURFACEN * c, LPRECT d, DWORD e) = 0;                                                               \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::BltBatch)                                                                                \
    (x * pThis, LPDDBLTBATCH a, DWORD b, DWORD c) = 0;                                                                                          \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::GetCaps)                                                                                 \
    (x * pThis, DDSCAPSN * lpddscaps) = 0;                                                                                                      \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::GetSurfaceDesc)                                                                          \
    (x * pThis, DDSURFACEDESCN * lpddsdesc) = 0;                                                                                                \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::GetPixelFormat)                                                                          \
    (x * pThis, LPDDPIXELFORMAT lpddpfmt) = 0;                                                                                                  \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::Flip)                                                                                    \
    (x * pThis, x * pOther, DWORD flags) = 0;                                                                                                   \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::Lock)                                                                                    \
    (x * pThis, LPRECT a, DDSURFACEDESCN * b, DWORD c, HANDLE d) = 0;                                                                           \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::Unlock)                                                                                  \
    (x * pThis, UNLOCKARG a) = 0;                                                                                                               \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::GetDC)                                                                                   \
    (x * pThis, HDC * lphDC) = 0;                                                                                                               \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::ReleaseDC)                                                                               \
    (x * pThis, HDC hDC) = 0;                                                                                                                   \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::GetAttachedSurface)                                                                      \
    (x * pThis, DDSCAPSN * lpddscaps, x * *ppsurf) = 0;                                                                                         \
    ...
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::GetFlipStatus)                                                                           \
    (x * pThis, DWORD flags) = 0;                                                                                                               \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::SetPalette)                                                                              \
    (x * pThis, LPDIRECTDRAWPALETTE pPalette) = 0;                                                                                              \
    template<>                                                                                                                                  \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawSurface<x>::SetColorKey)                                                                             \
    (x * pThis, DWORD dwFlags, LPDDCOLORKEY pKey) = 0;                                                                                          \
    template<>                                                                                                                                  \
    std::map<x*, x*> MyDirectDrawSurface<x>::attachedSurfaces;                                                                                  \
    template<>                                                                                                                                  \
    std::map<x*, x*> MyDirectDrawSurface<x>::sysMemCopySurfaces;                                                                                \
    template<>                                                                                                                                  \
    std::map<x*, void*> MyDirectDrawSurface<x>::videoMemoryPixelBackup;                                                                         \
    template<>                                                                                                                                  \
    std::map<x*, BOOL> MyDirectDrawSurface<x>::videoMemoryBackupDirty;
...
#undef HRESULT
    ...
    bool RedrawScreenDDraw()
    {
        if (dds_bltsaved)
        {
            ...
            HRESULT rv =
                dds_bltsaved->Blt(a_bltsaved, b_bltsaved, c_bltsaved, d_bltsaved, e_bltsaved);
            return true;
        }
        return false;
    }
    ...
    public:
        ...
        typedef HRESULT(FAR PASCAL* LPDDENUMSURFACESCALLBACKN)(DIRECTDRAWSURFACEN*,
                                                               DDSURFACEDESCN*,
                                                               LPVOID);
        ...
        (DWORD dwFlags, LPPALETTEENTRY b, LPDIRECTDRAWPALETTE FAR* c, IUnknown FAR* d)
        {
            ENTER();
            if (tasflags.forceWindowed)
            {
        ...
        (DDSURFACEDESCN* lpddsd, DIRECTDRAWSURFACEN* FAR* ppdds, IUnknown FAR* pUnkOuter)
        {
            if (!lpddsd)
                return E_POINTER;
            ...
            bool isPrimary =
                (ddsd.dwFlags & DDSD_CAPS) && (ddsd.ddsCaps.dwCaps & DDSCAPS_PRIMARYSURFACE);
            bool autoAttachSurface = false;
            bool autoClipSurface = false;
            if (isPrimary && (!(ddsd.dwFlags & DDSD_BACKBUFFERCOUNT) || !ddsd.dwBackBufferCount)
                && IDirectDrawTraits<IDirectDrawN>::NUMBER
                       <= 2) // hack: version check is to avoid breaking BMD.
            {
            ...
            if (tasflags.forceWindowed)
            {
                ...
                if (isPrimary)
                {
                    if ((ddsd.ddsCaps.dwCaps & (DDSCAPS_FLIP | DDSCAPS_COMPLEX))
                        || IsWindowFakeFullscreen(gamehwnd))
            ...
            case 2:
                ...
                capsToTry[numCapsToTry++] =
                    ...
                    & ~(DDSCAPS_SYSTEMMEMORY | DDSCAPS_LOCALVIDMEM);
                break;
            case 3:
                // local video memory
                capsToTry[numCapsToTry++] =
                    (ddsd.ddsCaps.dwCaps | DDSCAPS_VIDEOMEMORY | DDSCAPS_LOCALVIDMEM)
                    & ~(DDSCAPS_SYSTEMMEMORY | DDSCAPS_NONLOCALVIDMEM);
                break;
            }
            ...
            capsToTry[numCapsToTry++] =
                ddsd.ddsCaps.dwCaps
                & ~(DDSCAPS_SYSTEMMEMORY | DDSCAPS_VIDEOMEMORY | DDSCAPS_LOCALVIDMEM
            ...
            if (SUCCEEDED(hr))
            {
                ...
                if (autoAttachSurface)
                {
                    ...
                    if (IDirectDrawTraits<IDirectDrawN>::NUMBER == 7)
                        ddsd.ddsCaps.dwCaps |=
                            DDSCAPS_3DDEVICE; // fixes various d3d7 games (such as Ninjah and maybe BMD) when in fake fullscreen mode: Direct3DCreateDevice7 will fail if we don't request this capability for our backbuffer
                    ...
                    if (SUCCEEDED(hr))
                    {
                        MyDirectDrawSurface<DIRECTDRAWSURFACEN>::SetAttachedFakeBackBuf(
                            *ppdds, pAttachedSurface);
                        if (isPrimary)
                        {
                            ...
                            IDirectDrawOwnerInfo info = {(void*) this,
                                                         IDirectDrawTraits<IDirectDrawN>::NUMBER};
        ...
        STDMETHOD(GetDisplayMode)(DDSURFACEDESCN* lpddsd)
        {
            ...
            if (SUCCEEDED(rv) && fakeDisplayValid)
            {
                ...
                if (fakePixelFormatBPP)
                    lpddsd->ddpfPixelFormat.dwRGBBitCount =
                        fakePixelFormatBPP; // FIXME leaking info to game that might potentially cause desync... but it seems to help avoid graphics issues
            }
        ...
        (DWORD width, DWORD height, DWORD bpp) IMPOSSIBLE_IMPL STDMETHOD(
            SetDisplayMode)(DWORD width, DWORD height, DWORD bpp, DWORD refresh, DWORD flags)
        {
        ...
        (LPSIZE a, DWORD b, DWORD c) IMPOSSIBLE_IMPL
            STDMETHOD(EvaluateMode)(DWORD a, DWORD* b) IMPOSSIBLE_IMPL

            private : IDirectDrawN* m_dd;
    };

    template<>
    HRESULT MyDirectDraw<IDirectDraw>::GetAvailableVidMem(DDSCAPSN* a,
                                                          LPDWORD b,
                                                          LPDWORD c) IMPOSSIBLE_IMPL template<>
    HRESULT MyDirectDraw<IDirectDraw>::GetSurfaceFromDC(HDC a,
                                                        DIRECTDRAWSURFACEN** b) IMPOSSIBLE_IMPL
        template<>
        HRESULT MyDirectDraw<IDirectDraw>::RestoreAllSurfaces() IMPOSSIBLE_IMPL template<>
        HRESULT MyDirectDraw<IDirectDraw>::TestCooperativeLevel() IMPOSSIBLE_IMPL template<>
        HRESULT MyDirectDraw<IDirectDraw>::GetDeviceIdentifier(LPDDDEVICEIDENTIFIER a,
                                                               DWORD b) IMPOSSIBLE_IMPL

        template<>
        HRESULT MyDirectDraw<IDirectDraw2>::GetSurfaceFromDC(HDC a,
                                                             DIRECTDRAWSURFACEN** b) IMPOSSIBLE_IMPL
        template<>
        HRESULT MyDirectDraw<IDirectDraw2>::RestoreAllSurfaces() IMPOSSIBLE_IMPL template<>
        HRESULT MyDirectDraw<IDirectDraw2>::TestCooperativeLevel() IMPOSSIBLE_IMPL template<>
        HRESULT MyDirectDraw<IDirectDraw2>::GetDeviceIdentifier(LPDDDEVICEIDENTIFIER a,
                                                                DWORD b) IMPOSSIBLE_IMPL

        template<>
        HRESULT MyDirectDraw<IDirectDraw>::SetDisplayMode(DWORD width,
                                                          DWORD height,
                                                          DWORD bpp,
                                                          DWORD refresh,
                                                          DWORD flags) IMPOSSIBLE_IMPL template<>
        HRESULT MyDirectDraw<IDirectDraw>::SetDisplayMode(DWORD width, DWORD height, DWORD bpp)
    {
    ...
    template<>
    HRESULT MyDirectDraw<IDirectDraw7>::StartModeTest(LPSIZE a, DWORD b, DWORD c)
    {
        ENTER();
        //	if(tasflags.forceWindowed)
        //		return DD_OK;
    ...
    template<>
    HRESULT MyDirectDraw<IDirectDraw7>::EvaluateMode(DWORD a, DWORD* b)
    {
        ENTER();
        //	if(tasflags.forceWindowed)
        //		return DD_OK;
    ...
    template<>
    const GUID MyDirectDraw<IDirectDraw>::IID_IDirectDrawSurfaceN = IID_IDirectDrawSurface;
    template<>
    const GUID MyDirectDraw<IDirectDraw2>::IID_IDirectDrawSurfaceN = IID_IDirectDrawSurface;
    template<>
    const GUID MyDirectDraw<IDirectDraw4>::IID_IDirectDrawSurfaceN = IID_IDirectDrawSurface4;
    template<>
    const GUID MyDirectDraw<IDirectDraw7>::IID_IDirectDrawSurfaceN = IID_IDirectDrawSurface7;
    ...
    struct MyDirectDrawGammaControl
    {
        ...
        static HRESULT(STDMETHODCALLTYPE* GetGammaRamp)(IDirectDrawGammaControl* pThis,
                                                        DWORD dwFlags,
                                                        LPDDGAMMARAMP pRamp);
        static HRESULT STDMETHODCALLTYPE MyGetGammaRamp(IDirectDrawGammaControl* pThis,
                                                        DWORD dwFlags,
                                                        LPDDGAMMARAMP pRamp)
        {
            ENTER();
            ...
            if (pRamp)
            {
                ...
                {
                    for (int i = 0; i < 256; i++)
                        dstReds[i] = g_gammaRamp.red[i];
                    for (int i = 0; i < 256; i++)
                        dstGreens[i] = g_gammaRamp.green[i];
                    for (int i = 0; i < 256; i++)
                        dstBlues[i] = g_gammaRamp.blue[i];
                }
                else
                {
                    for (int i = 0; i < 256; i++)
        ...
        static HRESULT(STDMETHODCALLTYPE* SetGammaRamp)(IDirectDrawGammaControl* pThis,
                                                        DWORD dwFlags,
                                                        LPDDGAMMARAMP pRamp);
        static HRESULT STDMETHODCALLTYPE MySetGammaRamp(IDirectDrawGammaControl* pThis,
                                                        DWORD dwFlags,
                                                        LPDDGAMMARAMP pRamp)
        {
            ENTER();
            ...
            if (pRamp)
            {
                ...
                for (int i = 0; i < 256; i++)
                    g_gammaRamp.red[i] = srcReds[i];
                for (int i = 0; i < 256; i++)
                    g_gammaRamp.green[i] = srcGreens[i];
                for (int i = 0; i < 256; i++)
                    g_gammaRamp.blue[i] = srcBlues[i];
                g_gammaRampEnabled = true;
                if (g_gammaRamp.red[255] == 65535 && g_gammaRamp.green[255] == 65535
                    && g_gammaRamp.blue[255] == 65535)
        ...
        static HRESULT(STDMETHODCALLTYPE* QueryInterface)(IDirectDrawGammaControl* pThis,
                                                          REFIID riid,
                                                          void** ppvObj);
        static HRESULT STDMETHODCALLTYPE MyQueryInterface(IDirectDrawGammaControl* pThis,
                                                          REFIID riid,
                                                          void** ppvObj)
        {
            ENTER(riid.Data1);
...
#define DEF(x)                                                           \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawGammaControl::QueryInterface) \
    (x * pThis, REFIID riid, void** ppvObj) = 0;                         \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawGammaControl::GetGammaRamp)   \
    (x * pThis, DWORD dwFlags, LPDDGAMMARAMP pRamp) = 0;                 \
    HRESULT(STDMETHODCALLTYPE* MyDirectDrawGammaControl::SetGammaRamp)   \
    (x * pThis, DWORD dwFlags, LPDDGAMMARAMP pRamp) = 0;
...
#undef DEF
    ...
    HOOKFUNC HRESULT WINAPI MyDirectDrawCreate(GUID FAR* lpGUID,
                                               LPDIRECTDRAW FAR* lplpDD,
                                               IUnknown FAR* pUnkOuter)
    {
        ENTER();
    ...
    HOOK_FUNCTION(HRESULT,
                  ...
                  REFIID riid,
                  IUnknown FAR* pUnkOuter);
    HOOKFUNC HRESULT WINAPI MyDirectDrawCreateEx(GUID FAR* lpGuid,
                                                 LPVOID* lplpDD,
                                                 REFIID riid,
                                                 IUnknown FAR* pUnkOuter)
    {
