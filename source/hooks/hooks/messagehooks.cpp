...
#define GWMNcase(wm) \
    case wm:         \
        return #wm;
            GWMNcase(WM_NULL) GWMNcase(WM_PAINT) GWMNcase(WM_CREATE) GWMNcase(WM_DESTROY) GWMNcase(
                WM_MOVE) GWMNcase(WM_SIZE) GWMNcase(WM_ACTIVATE) GWMNcase(WM_SETFOCUS) GWMNcase(WM_KILLFOCUS)
                GWMNcase(WM_ENABLE) GWMNcase(WM_SETREDRAW) GWMNcase(WM_SETTEXT) GWMNcase(WM_GETTEXT) GWMNcase(
                    WM_GETTEXTLENGTH) GWMNcase(WM_CLOSE) GWMNcase(WM_QUERYENDSESSION) GWMNcase(WM_QUERYOPEN)
                    GWMNcase(WM_ENDSESSION) GWMNcase(WM_QUIT) GWMNcase(WM_ERASEBKGND) GWMNcase(
                        WM_SYSCOLORCHANGE) GWMNcase(WM_SHOWWINDOW) GWMNcase(WM_WININICHANGE) GWMNcase(WM_DEVMODECHANGE)
                        GWMNcase(WM_ACTIVATEAPP) GWMNcase(WM_FONTCHANGE) GWMNcase(WM_TIMECHANGE) GWMNcase(
                            WM_CANCELMODE) GWMNcase(WM_SETCURSOR) GWMNcase(WM_MOUSEACTIVATE) GWMNcase(WM_CHILDACTIVATE)
                            GWMNcase(WM_QUEUESYNC) GWMNcase(WM_GETMINMAXINFO) GWMNcase(WM_PAINTICON) GWMNcase(
                                WM_ICONERASEBKGND) GWMNcase(WM_NEXTDLGCTL) GWMNcase(WM_SPOOLERSTATUS)
                                GWMNcase(WM_DRAWITEM) GWMNcase(WM_MEASUREITEM) GWMNcase(WM_DELETEITEM) GWMNcase(
                                    WM_VKEYTOITEM) GWMNcase(WM_CHARTOITEM) GWMNcase(WM_SETFONT)
                                    GWMNcase(WM_GETFONT) GWMNcase(WM_SETHOTKEY) GWMNcase(WM_GETHOTKEY) GWMNcase(
                                        WM_QUERYDRAGICON) GWMNcase(WM_COMPAREITEM) GWMNcase(WM_GETOBJECT)
                                        GWMNcase(WM_COMPACTING) GWMNcase(WM_COMMNOTIFY) GWMNcase(
                                            WM_WINDOWPOSCHANGING) GWMNcase(WM_WINDOWPOSCHANGED) GWMNcase(WM_POWER)
                                            GWMNcase(WM_COPYDATA) GWMNcase(WM_CANCELJOURNAL) GWMNcase(
                                                WM_NOTIFY) GWMNcase(WM_INPUTLANGCHANGEREQUEST)
                                                GWMNcase(WM_INPUTLANGCHANGE) GWMNcase(WM_TCARD) GWMNcase(
                                                    WM_HELP) GWMNcase(WM_USERCHANGED) GWMNcase(WM_NOTIFYFORMAT)
                                                    GWMNcase(WM_CONTEXTMENU) GWMNcase(WM_STYLECHANGING) GWMNcase(
                                                        WM_STYLECHANGED) GWMNcase(WM_DISPLAYCHANGE)
                                                        GWMNcase(WM_GETICON) GWMNcase(WM_SETICON) GWMNcase(
                                                            WM_NCCREATE) GWMNcase(WM_NCDESTROY)
                                                            GWMNcase(WM_NCCALCSIZE) GWMNcase(
                                                                WM_NCHITTEST) GWMNcase(WM_NCPAINT)
                                                                GWMNcase(WM_NCACTIVATE) GWMNcase(
                                                                    WM_GETDLGCODE) GWMNcase(WM_SYNCPAINT)
                                                                    GWMNcase(WM_NCMOUSEMOVE) GWMNcase(
                                                                        WM_NCLBUTTONDOWN) GWMNcase(WM_NCLBUTTONUP)
                                                                        GWMNcase(WM_NCLBUTTONDBLCLK) GWMNcase(
                                                                            WM_NCRBUTTONDOWN) GWMNcase(WM_NCRBUTTONUP)
                                                                            GWMNcase(WM_NCRBUTTONDBLCLK) GWMNcase(
                                                                                WM_NCMBUTTONDOWN)
                                                                                GWMNcase(WM_NCMBUTTONUP) GWMNcase(
                                                                                    WM_NCMBUTTONDBLCLK)
                                                                                    GWMNcase(
                                                                                        WM_NCXBUTTONDOWN)
                                                                                        GWMNcase(
                                                                                            WM_NCXBUTTONUP)
                                                                                            GWMNcase(
                                                                                                WM_NCXBUTTONDBLCLK) case /*WM_NCUAHDRAWCAPTION*/
                0xAE : return "WM_NCUAHDRAWCAPTION";
        case /*WM_NCUAHDRAWFRAME*/ 0xAF:
            return "WM_NCUAHDRAWFRAME";
        case /*WM_INPUT_DEVICE_CHANGE*/ 0x00FE:
            return "WM_INPUT_DEVICE_CHANGE";
        case /*WM_INPUT*/ 0x00FF:
            return "WM_INPUT";
            GWMNcase(WM_KEYDOWN) GWMNcase(WM_KEYUP) GWMNcase(WM_CHAR) GWMNcase(WM_DEADCHAR)
                GWMNcase(WM_SYSKEYDOWN) GWMNcase(WM_SYSKEYUP) GWMNcase(WM_SYSCHAR)
                    GWMNcase(WM_SYSDEADCHAR) case /*WM_UNICHAR*/ 0x0109 : return "WM_UNICHAR";
            GWMNcase(WM_IME_STARTCOMPOSITION) GWMNcase(WM_IME_ENDCOMPOSITION)
                GWMNcase(WM_IME_COMPOSITION) GWMNcase(WM_INITDIALOG) GWMNcase(WM_COMMAND)
                    GWMNcase(WM_SYSCOMMAND) GWMNcase(WM_TIMER) GWMNcase(WM_HSCROLL)
                        GWMNcase(WM_VSCROLL) GWMNcase(WM_INITMENU)
                            GWMNcase(WM_INITMENUPOPUP) case /*	*/ 0x0118 : return "WM_SYSTIMER";
            GWMNcase(WM_MENUSELECT) GWMNcase(WM_MENUCHAR) GWMNcase(WM_ENTERIDLE) GWMNcase(
                WM_MENURBUTTONUP) GWMNcase(WM_MENUDRAG) GWMNcase(WM_MENUGETOBJECT)
                GWMNcase(WM_UNINITMENUPOPUP) GWMNcase(WM_MENUCOMMAND) GWMNcase(WM_CHANGEUISTATE)
                    GWMNcase(WM_UPDATEUISTATE) GWMNcase(WM_QUERYUISTATE) GWMNcase(WM_CTLCOLORMSGBOX)
                        GWMNcase(WM_CTLCOLOREDIT) GWMNcase(WM_CTLCOLORLISTBOX) GWMNcase(
                            WM_CTLCOLORBTN) GWMNcase(WM_CTLCOLORDLG) GWMNcase(WM_CTLCOLORSCROLLBAR)
                            GWMNcase(WM_CTLCOLORSTATIC) GWMNcase(WM_MOUSEMOVE) GWMNcase(
                                WM_LBUTTONDOWN) GWMNcase(WM_LBUTTONUP) GWMNcase(WM_LBUTTONDBLCLK)
                                GWMNcase(WM_RBUTTONDOWN) GWMNcase(WM_RBUTTONUP)
                                    GWMNcase(WM_RBUTTONDBLCLK) GWMNcase(WM_MBUTTONDOWN)
                                        GWMNcase(WM_MBUTTONUP) GWMNcase(WM_MBUTTONDBLCLK)
                                            GWMNcase(WM_MOUSEWHEEL) GWMNcase(WM_XBUTTONDOWN)
                                                GWMNcase(WM_XBUTTONUP) GWMNcase(
                                                    WM_XBUTTONDBLCLK) case /*WM_MOUSEHWHEEL*/ 0x020E
                : return "WM_MOUSEHWHEEL";
            GWMNcase(WM_PARENTNOTIFY) GWMNcase(WM_ENTERMENULOOP) GWMNcase(WM_EXITMENULOOP) GWMNcase(
                WM_NEXTMENU) GWMNcase(WM_SIZING) GWMNcase(WM_CAPTURECHANGED) GWMNcase(WM_MOVING)
                GWMNcase(WM_POWERBROADCAST) GWMNcase(WM_DEVICECHANGE) GWMNcase(WM_MDICREATE)
                    GWMNcase(WM_MDIDESTROY) GWMNcase(WM_MDIACTIVATE) GWMNcase(WM_MDIRESTORE)
                        GWMNcase(WM_MDINEXT) GWMNcase(WM_MDIMAXIMIZE) GWMNcase(WM_MDITILE) GWMNcase(
                            WM_MDICASCADE) GWMNcase(WM_MDIICONARRANGE) GWMNcase(WM_MDIGETACTIVE)
                            GWMNcase(WM_MDISETMENU) GWMNcase(WM_ENTERSIZEMOVE)
                                GWMNcase(WM_EXITSIZEMOVE) GWMNcase(WM_DROPFILES)
                                    GWMNcase(WM_MDIREFRESHMENU) GWMNcase(WM_IME_SETCONTEXT)
                                        GWMNcase(WM_IME_NOTIFY) GWMNcase(WM_IME_CONTROL)
                                            GWMNcase(WM_IME_COMPOSITIONFULL) GWMNcase(WM_IME_SELECT)
                                                GWMNcase(WM_IME_CHAR) case /*WM_IME_SYSTEM*/ 0x0287
                : return "WM_IME_SYSTEM";
            GWMNcase(WM_IME_REQUEST) GWMNcase(WM_IME_KEYDOWN) GWMNcase(WM_IME_KEYUP)
                GWMNcase(WM_MOUSEHOVER) GWMNcase(WM_MOUSELEAVE) GWMNcase(WM_NCMOUSEHOVER)
                    GWMNcase(WM_NCMOUSELEAVE) GWMNcase(WM_CUT) GWMNcase(WM_COPY) GWMNcase(WM_PASTE)
                        GWMNcase(WM_CLEAR) GWMNcase(WM_UNDO) GWMNcase(WM_RENDERFORMAT)
                            GWMNcase(WM_RENDERALLFORMATS) GWMNcase(WM_DESTROYCLIPBOARD) GWMNcase(
                                WM_DRAWCLIPBOARD) GWMNcase(WM_PAINTCLIPBOARD)
                                GWMNcase(WM_VSCROLLCLIPBOARD) GWMNcase(WM_SIZECLIPBOARD) GWMNcase(
                                    WM_ASKCBFORMATNAME) GWMNcase(WM_CHANGECBCHAIN)
                                    GWMNcase(WM_HSCROLLCLIPBOARD) GWMNcase(WM_QUERYNEWPALETTE)
                                        GWMNcase(WM_PALETTEISCHANGING) GWMNcase(WM_PALETTECHANGED)
                                            GWMNcase(WM_HOTKEY) case /*WM_POPUPSYSTEMMENU*/ 0x0313
                : return "WM_POPUPSYSTEMMENU";
            GWMNcase(WM_PRINT) GWMNcase(WM_PRINTCLIENT)
                GWMNcase(WM_APPCOMMAND) case /*WM_CLIPBOARDUPDATE*/ 0x031D
                : return "WM_CLIPBOARDUPDATE";
        case /*WM_GETTITLEBARINFOEX*/ 0x033F:
            return "WM_GETTITLEBARINFOEX";
            GWMNcase(WM_APP)
#undef GWMNcase
                default : if (isMessageWhitelisted(message)) return GetWindowsMessageName(
                              toggleWhitelistMessage(message));
            if (message >= 0xC000 && message <= 0xFFFF)
            {
                static char temp[64];
                if (GetClipboardFormatNameA(
                        message,
                        temp,
                        ARRAYSIZE(temp))) // hack, should call NtUserGetAtomName instead?
                    return temp;
            }
            return "?";
        }
    ...
    static MessageActionFlags GetMessageActionFlags(UINT message, WPARAM wParam, LPARAM lParam)
    {
        ...
        if (isMessageWhitelisted(
                message)) // things sent with SendMessage toggleWhitelistMessage(message) are considered safe to send to the game.
...

        {
            ...
            if (message == WM_PAINT || message == WM_NCPAINT || message == WM_ERASEBKGND
                || message == WM_SETICON
                || message == 0xAE /*WM_NCUAHDRAWCAPTION*/
                || message == 0xAF /*WM_NCUAHDRAWFRAME*/
                || message == WM_GETICON
        ...
        case WM_COMMAND:
            if (VerifyIsTrustedCaller())
                return MAF_PASSTHROUGH
                       | MAF_RETURN_OS; // hack to fix F2 command in Eternal Daughter
            break;
        default:
    ...
    {
        return msg
               && !(GetMessageActionFlags(msg->message, msg->wParam, msg->lParam)
                    & (MAF_BYPASSGAME | MAF_INTERCEPT));
    }
    ...
    LRESULT CustomHandleWndProcMessage(HWND hWnd,
                                       UINT message,
                                       WPARAM wParam,
                                       LPARAM lParam,
                                       LRESULT defaultReturnValue)
    {
        switch (message)
        {
        case WM_NCMOUSEMOVE:
                                    ...
                                    MessageActionFlags maf /*=MAF_PASSTHROUGH|MAF_RETURN_OS*/)
    {
        ...
        if (/*inPauseHandler || */
            !VerifyIsTrustedCaller()) // if it's the OS or pause handler calling us back,
        ...
        else // MAF_PASSTHROUGH
        {
            ...
            rv = (ascii ? CallWindowProcA
                        : CallWindowProcW)(origProc, hWnd, message, wParam, lParam);
        }
    ...
    HOOKFUNC LRESULT WINAPI MyCallNextHookEx(HHOOK hhk, int nCode, WPARAM wParam, LPARAM lParam)
    {
        ...
        LRESULT rv;
        if (nCode
            < 0) // negative supposedly means calling the hook is required... never seen that happen but I'll trust msdn for now
        {
...
//}
    ...
    static void TrackMessageQueueStatusChange(MessageQueue& mq, DWORD message, int delta)
    {
        if (delta)
        {
            ...
            case /*WM_INPUT_DEVICE_CHANGE*/ 0x00FE:
                mq.rawinput += delta;
                if (mq.rawinput > 0)
                    mq.queueStatus |= /*QS_RAWINPUT*/ 0x0400;
                else
                    mq.queueStatus &= ~/*QS_RAWINPUT*/ 0x0400;
                break;
            case WM_QUIT:
    ...
    static void AddMessageToQueue(MessageQueue& mq, MyMSG& mymsg)
    {
        ...
        debuglog(LCF_MESSAGES | LCF_FREQUENT,
                 __FUNCTION__ ": added message (0x%X, 0x%X (%s), 0x%X, 0x%X) to internal message "
                              "queue.\n",
                 msg.hwnd,
                 msg.message,
                 GetWindowsMessageName(msg.message),
                 msg.wParam,
                 msg.lParam);
    }
    ...
    static void InternalizeMessageQueue()
    {
        ...
        while (PeekMessageA(&msg, NULL, 0, 0, PM_REMOVE | PM_NOYIELD))
        {
            ...
            {
                debuglog(LCF_MESSAGES | LCF_FREQUENT,
                         __FUNCTION__ ": got message (0x%X, 0x%X (%s), 0x%X, 0x%X), but handling "
                                      "it internally.\n",
                         msg.hwnd,
                         msg.message,
                         GetWindowsMessageName(msg.message),
            ...
            {
                debuglog(LCF_MESSAGES | LCF_TODO | LCF_UNTESTED,
                         __FUNCTION__ ": got message (0x%X (%s), 0x%X, 0x%X), but unable to handle "
                                      "it due to no HWND.\n",
                         msg.message,
                         GetWindowsMessageName(msg.message),
                         msg.wParam,
                             ...
                             MessageActionFlags maf /*=MAF_PASSTHROUGH|MAF_RETURN_OS*/)
    {
        ...
        if (CanMessageReachGame(maf))
        {
            ...
            MyMSG mymsg =
                {hWnd, message, wParam, lParam, detTimer.GetTicks(), pt /*, ascii*/}; // TEMP
            AddMessageToQueue(pmq ? (*pmq) : tls.messageQueue, mymsg);
        }
        else if (hWnd)
        {
            debuglog(LCF_MESSAGES | LCF_FREQUENT,
                     __FUNCTION__ ": got message (0x%X, 0x%X (%s), 0x%X, 0x%X), but handling it "
                                  "internally.\n",
                     hWnd,
                     message,
                     GetWindowsMessageName(message),
                     wParam,
                     lParam);
        ...
        {
            debuglog(LCF_MESSAGES | LCF_TODO | LCF_UNTESTED,
                     __FUNCTION__ ": got message (0x%X (%s), 0x%X, 0x%X), but unable to handle it "
                                  "due to no HWND.\n",
                     message,
                     GetWindowsMessageName(message),
                     wParam,
...
#else
        (ascii ? PostMessageA : PostMessageW)(hWnd,
                                              isMessageWhitelisted(message)
                                                  ? message
                                                  : toggleWhitelistMessage(message),
                                              wParam,
                                              lParam);
    ...
    HOOKFUNC BOOL WINAPI MySendNotifyMessageA(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam)
    {
        ...
        {
            return DispatchMessageInternal(hWnd,
                                           Msg,
                                           wParam,
                                           lParam,
                                           true,
                                           GetMessageActionFlags(Msg, wParam, lParam)
                                               & ~MAF_BYPASSGAME);
        }
        else
        {
            ...
            debuglog(
                LCF_MESSAGES | LCF_TODO | LCF_UNTESTED,
                __FUNCTION__ "(0x%X (%s)) denied because different-thread destination is NYI.\n",
                Msg,
                GetWindowsMessageName(Msg));
            return 0;
        }
#else
    ...
    HOOKFUNC LRESULT WINAPI MySendMessageTimeoutA(HWND hWnd,
                                                  UINT Msg,
                                                  WPARAM wParam,
                                                  LPARAM lParam,
                                                  UINT fuFlags,
...
#else
        return SendMessageTimeoutA(hWnd,
                                   whitelistUserMessage(Msg),
                                   wParam,
                                   lParam,
                                   fuFlags,
                                   uTimeout,
    ...
    HOOK_FUNCTION(LRESULT,
                  ...
                  UINT uTimeout,
                  PDWORD_PTR lpdwResult);
    HOOKFUNC LRESULT WINAPI MySendMessageTimeoutW(HWND hWnd,
                                                  UINT Msg,
                                                  WPARAM wParam,
                                                  LPARAM lParam,
                                                  UINT fuFlags,
    ...
    HOOK_FUNCTION(LRESULT,
                  ...
                  ULONG_PTR dwData);
    HOOKFUNC LRESULT WINAPI MySendMessageCallbackA(HWND hWnd,
                                                   UINT Msg,
                                                   WPARAM wParam,
                                                   LPARAM lParam,
                                                   SENDASYNCPROC lpResultCallBack,
                                                   ULONG_PTR dwData)
    {
        ...
        if (std::find(v.begin(), v.end(), hWnd) != v.end())
        {
            LRESULT lResult = DispatchMessageInternal(hWnd,
                                                      Msg,
                                                      wParam,
                                                      lParam,
                                                      true,
        ...
        if (tasflags.messageSyncMode >= 2)
        {
            return SendMessageCallbackA(hWnd,
                                        whitelistUserMessage(Msg),
                                        wParam,
                                        lParam,
                                        lpResultCallBack,
    ...
    HOOK_FUNCTION(LRESULT,
                  ...
                  SENDASYNCPROC lpResultCallBack,
                  ULONG_PTR dwData);
    HOOKFUNC LRESULT WINAPI MySendMessageCallbackW(HWND hWnd,
                                                   UINT Msg,
                                                   WPARAM wParam,
                                                   LPARAM lParam,
                                                   SENDASYNCPROC lpResultCallBack,
                                                   ULONG_PTR dwData)
    {
        ...
        if (tasflags.messageSyncMode >= 2)
        {
            return SendMessageCallbackW(hWnd,
                                        whitelistUserMessage(Msg),
                                        wParam,
                                        lParam,
                                        lpResultCallBack,
    ...
    HOOKFUNC BOOL WINAPI MyPostMessageW(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam)
    {
        ...
        if (std::find(v.begin(), v.end(), hWnd) != v.end())
        {
            PostMessageInternal(hWnd,
                                Msg,
                                wParam,
                                lParam,
                                true,
                                &mq,
                                GetMessageActionFlags(Msg, wParam, lParam) & ~MAF_BYPASSGAME);
            return TRUE;
        }
        else
        {
    ...
    HOOK_FUNCTION(BOOL,
                  ...
                  WPARAM wParam,
                  LPARAM lParam);
    HOOKFUNC BOOL WINAPI MyPostThreadMessageA(DWORD idThread,
                                              UINT Msg,
                                              WPARAM wParam,
                                              LPARAM lParam)
    {
    ...
    HOOK_FUNCTION(BOOL,
                  ...
                  WPARAM wParam,
                  LPARAM lParam);
    HOOKFUNC BOOL WINAPI MyPostThreadMessageW(DWORD idThread,
                                              UINT Msg,
                                              WPARAM wParam,
                                              LPARAM lParam)
    {
    ...
    HOOKFUNC LRESULT WINAPI MyDispatchMessageA(CONST MSG* lpMsg)
    {
        if (lpMsg)
        {
            ENTER(lpMsg->hwnd,
                  lpMsg->message,
                  GetWindowsMessageName(lpMsg->message),
                  lpMsg->wParam,
                  lpMsg->lParam);
        }
...
//	return 1;
        ...
        const MSG& msg = *lpMsg;
        LRESULT rv = DispatchMessageInternal(msg.hwnd,
                                             msg.message,
                                             msg.wParam,
                                             msg.lParam,
                                             true,
...
//	return 1;
    ...
    HOOK_FUNCTION(BOOL,
                  ...
                  UINT wMsgFilterMin,
                  UINT wMsgFilterMax);
    HOOKFUNC BOOL WINAPI MyGetMessageA(LPMSG lpMsg,
                                       HWND hWnd,
                                       UINT wMsgFilterMin,
                                       UINT wMsgFilterMax)
    {
            ...
            for (iter = mq.messages.begin(); iter != mq.messages.end(); iter++)
            {
                ...
                if (!hWnd || hWnd == msg.hwnd || (hWnd == (HWND) -1 && !msg.hwnd))
                {
                        ...
                        || (msg.message >= wMsgFilterMin && msg.message <= wMsgFilterMax))
                    {
                        *lpMsg = msg;
                        debuglog(LCF_MESSAGES | LCF_FREQUENT,
                                 __FUNCTION__ ": got message (0x%X, 0x%X (%s), 0x%X, 0x%X) from "
    ...
    HOOK_FUNCTION(BOOL,
                  ...
                  UINT wMsgFilterMin,
                  UINT wMsgFilterMax);
    HOOKFUNC BOOL WINAPI MyGetMessageW(LPMSG lpMsg,
                                       HWND hWnd,
                                       UINT wMsgFilterMin,
                                       UINT wMsgFilterMax)
    {
        ...
        while (true)
        {
            ...
            BOOL rv = FALSE;
            if (tasflags.messageSyncMode >= 2
                || (!tls_IsPrimaryThread() && tasflags.messageSyncMode != 0))
            {
...
//	return rv;
    ...
    MyPeekMessageA(LPMSG lpMsg, HWND hWnd, UINT wMsgFilterMin, UINT wMsgFilterMax, UINT wRemoveMsg)
    {
        ////	FrameBoundary();
            ...
            for (iter = mq.messages.begin(); iter != mq.messages.end(); iter++)
            {
                ...
                if (!hWnd || hWnd == msg.hwnd || (hWnd == (HWND) -1 && !msg.hwnd))
                {
                        ...
                        || (msg.message >= wMsgFilterMin && msg.message <= wMsgFilterMax))
                    {
                        *lpMsg = msg;
                        debuglog(LCF_MESSAGES | LCF_FREQUENT,
                                 __FUNCTION__ ": %s message (0x%X, 0x%X (%s), 0x%X, 0x%X) from "
                                              "internal message queue.\n",
                                 (wRemoveMsg & PM_REMOVE) ? "pulled" : "peeked",
                                 msg.hwnd,
                                 msg.message,
                                 GetWindowsMessageName(msg.message),
                                 msg.wParam,
                        ...
                        if (wRemoveMsg & PM_REMOVE)
                            mq.messages.erase(iter);
                        TrackMessageQueueStatusChange(mq,
                                                      msg.message,
                                                      (wRemoveMsg & PM_REMOVE) ? -1 : 0);
                        return TRUE;
                    }
                }
            }
        ...
        while (true)
        {
            ...
            else
            {
                ...
                FinalizeWndProcMessage(lpMsg);
                if ((wRemoveMsg & PM_REMOVE) || PeekMessageA(lpMsg,
                                                             hWnd,
                                                             wMsgFilterMin,
                                                             wMsgFilterMax,
...
//	return rv;
    ...
    HOOK_FUNCTION(BOOL,
                  ...
                  UINT wRemoveMsg);
    HOOKFUNC BOOL WINAPI
    MyPeekMessageW(LPMSG lpMsg, HWND hWnd, UINT wMsgFilterMin, UINT wMsgFilterMax, UINT wRemoveMsg)
    {
        ...
        while (true)
        {
            ...
            else
            {
                int prevmsg = lpMsg->message;
                FinalizeWndProcMessage(lpMsg);
                if ((wRemoveMsg & PM_REMOVE) || PeekMessageW(lpMsg,
                                                             hWnd,
                                                             wMsgFilterMin,
                                                             wMsgFilterMax,
                                                             PM_REMOVE | PM_NOYIELD))
...
//	return rv;
    ...
    HOOKFUNC DWORD WINAPI MyGetQueueStatus(UINT flags)
    {
...
#ifdef EMULATE_MESSAGE_QUEUES
        MessageQueue& mq = tls.messageQueue;
        DWORD rv = ((DWORD)(mq.queueStatus & flags) << 16)
                   | (mq.queueStatusAtLastGet & mq.queueStatus & flags);
        ...
        return (flags & 0xFFFF)
               | (flags
                  << 16); // I'm not sure what else I can do that's deterministic... (TODO: if the windows message queue is emulated then this can be made more accurate)
#endif
    }
