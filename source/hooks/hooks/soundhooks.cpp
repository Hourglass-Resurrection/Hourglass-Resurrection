...
DEFINE_LOCAL_GUID(IID_IDirectSound,
                  0x279AFA83,
                  0x4981,
                  0x11CE,
                  0xA5,
                  ...
                  0xE5,
                  0x60);
DEFINE_LOCAL_GUID(IID_IDirectSound8,
                  0xC50A7E93,
                  0xF395,
                  0x4834,
                  0x9E,
...
DEFINE_LOCAL_GUID(IID_IDirectSoundBuffer,
                  0x279AFA85,
                  0x4981,
                  0x11CE,
                  0xA5,
                  ...
                  0xE5,
                  0x60);
DEFINE_LOCAL_GUID(IID_IDirectSoundBuffer8,
                  0x6825A449,
                  0x7524,
                  0x4D82,
                  0x92,
                  ...
                  0xAB,
                  0x1E);
DEFINE_LOCAL_GUID(IID_IDirectSound3DBuffer,
                  0x279AFA86,
                  0x4981,
                  0x11CE,
                  0xA5,
                  ...
                  0xE5,
                  0x60);
DEFINE_LOCAL_GUID(IID_IDirectSoundNotify,
                  0xB0210783,
                  0x89CD,
                  0x11D0,
                  0xAF,
...
DEFINE_LOCAL_GUID(IID_IDirectMusic,
                  0x6536115A,
                  0x7B2D,
                  0x11D2,
                  0xBA,
                  ...
                  0xAC,
                  0x12);
DEFINE_LOCAL_GUID(IID_IDirectMusic2,
                  0x6FC2CAE1,
                  0xBC78,
                  0x11D2,
                  0xAF,
                  ...
                  0xD8,
                  0xB6);
DEFINE_LOCAL_GUID(IID_IDirectMusic8,
                  0x2D3629F7,
                  0x813D,
                  0x4939,
                  0x85,
                  ...
                  0xFD,
                  0x97);
DEFINE_LOCAL_GUID(IID_IDirectMusicPerformance,
                  0x07D43D03,
                  0x6523,
                  0x11D2,
                  0x87,
                  ...
                  0xB1,
                  0xBD);
DEFINE_LOCAL_GUID(IID_IDirectMusicPerformance2,
                  0x6FC2CAE0,
                  0xBC78,
                  0x11D2,
                  0xAF,
                  ...
                  0xD8,
                  0xB6);
DEFINE_LOCAL_GUID(IID_IDirectMusicPerformance8,
                  0x679C4137,
                  0xC62E,
                  0x4147,
                  0xB2,
...
DEFINE_LOCAL_GUID(IID_IBaseFilter,
                  0x56a86895,
                  0x0ad4,
                  0x11ce,
                  0xb0,
                  ...
                  0xa7,
                  0x70);
DEFINE_LOCAL_GUID(IID_IMediaFilter,
                  0x56a86899,
                  0x0ad4,
                  0x11ce,
                  0xb0,
...
DEFINE_LOCAL_GUID(IID_IDirectSoundSinkFactory,
                  0x2A8AF120,
                  0xE9DE,
                  0x4132,
                  0xAA,
                  ...
                  0x25,
                  0xB8);
DEFINE_LOCAL_GUID(IID_IDirectSoundSinkSync,
                  0x73A6A85A,
                  0x493E,
                  0x4C87,
                  0xB4,
                  ...
                  0x74,
                  0x4B);
DEFINE_LOCAL_GUID(IID_IKsControl,
                  0x28F54685,
                  0x06FD,
                  0x11D2,
                  0xB2,
...
void MixFromToInternal(DWORD pos1,
                       DWORD pos2,
                       DWORD outPos1,
                       DWORD outPos2,
                       bool pos2IsLastSample,
                       DWORD outSamplesPerSec,
                       WORD myBitsPerSample,
                       WORD outBitsPerSample,
                       WORD myChannels,
                       WORD outChannels,
                       WORD myBlockSize,
                       WORD outBlockSize,
                       unsigned char* buffer,
                       unsigned char* contiguousMixOutBuf,
                       Hooks::DirectSound::CachedVolumeAndPan& volumes);
...
namespace Hooks
{
    ...
    {
        using Log = DebugLog<LogCategory::DSOUND>;
        ...
        class EmulatedDirectSoundBuffer : public IDirectSoundBuffer8,
        ...
        public:
            ...
            EmulatedDirectSoundBuffer(bool isFakePrimary = false) : m_isFakePrimary(isFakePrimary)
            {
                ...
                LOG() << soundBuffers.size() << " emulated sound buffers.";
            ...
            ~EmulatedDirectSoundBuffer()
            {
                ...
                MyBufferList::iterator found =
                    std::find(soundBuffers.begin(), soundBuffers.end(), this);
            ...
            HRESULT STDMETHODCALLTYPE QueryInterface(REFIID riid, void** ppvObj)
            {
                ...
                if (riid == IID_IDirectSoundBuffer)
                    *ppvObj = (IDirectSoundBuffer*) this;
                    ...
                    && !m_isFakePrimary) // "IDirectSoundBuffer8 is not available for the primary buffer"
                    *ppvObj = (IDirectSoundBuffer8*) this;
                else if (riid == IID_IDirectSound3DBuffer)
                    *ppvObj = (IDirectSound3DBuffer*) this;
                else if (riid == IID_IDirectSoundNotify
                         && s_myMixingOutputBuffer != (IDirectSoundBuffer*) this)
                    *ppvObj =
                        (IDirectSoundNotify*) this; // lesson in multiple inheritance: these casts are required, since they select which vtable to use
            ...
            STDMETHOD(GetCaps)(LPDSBCAPS pDSBufferCaps)
            {
                ...
                pDSBufferCaps->dwUnlockTransferRate =
                    1024 * 1024; // not sure... should be "very high" whatever that means
                pDSBufferCaps->dwPlayCpuOverhead =
                    0; // pretend there's no processing overhead (that's standard hardware buffer behavior)
                return DS_OK;
            }
            STDMETHOD(GetCurrentPosition)
            (LPDWORD pdwCurrentPlayCursor, LPDWORD pdwCurrentWriteCursor)
            {
                ENTER(playCursor, writeCursor);
            ...
            (LPWAVEFORMATEX pwfxFormat, DWORD dwSizeAllocated, LPDWORD pdwSizeWritten)
            {
                ...
                if (!pwfxFormat)
                {
                    LOG() << "returned DSERR_INVALIDCALL.";
                ...
                else
                {
                    ...
                    pwfxFormat->nBlockAlign =
                        pwfxFormat->wBitsPerSample * pwfxFormat->nChannels / 8;
                    pwfxFormat->nAvgBytesPerSec =
                        pwfxFormat->nSamplesPerSec * pwfxFormat->nBlockAlign;
                    pwfxFormat->cbSize = 0;
                }
                if (pdwSizeWritten)
                    *pdwSizeWritten = size;
                if (pwfxFormat)
                    LEAVE(pwfxFormat->nSamplesPerSec,
            ...
            STDMETHOD(Initialize)(LPDIRECTSOUND pDirectSound, LPCDSBUFFERDESC pcDSBufferDesc)
            {
                ...
                if (waveformat)
                {
                    LOG() << "returned DSERR_ALREADYINITIALIZED.";
                    return DSERR_ALREADYINITIALIZED;
                }

                if (!pcDSBufferDesc)
                {
                    LOG() << "returned DSERR_INVALIDPARAM.";
                    return DSERR_INVALIDPARAM;
                }
                ...
                bufferSize = std::min<DWORD>(std::max<DWORD>(bufferSize, DSBSIZE_MIN), DSBSIZE_MAX);
            ...
            (DWORD dwOffset,
             ...
             DWORD dwFlags)
            {
                ENTER(this, dwOffset, dwBytes, dwFlags);
                ...
                {
                    LOG() << "(" << this << ") got (" << dwOffset << " - " << dwOffset + dwBytes;
                    if (pdwAudioBytes1)
                ...
                {
                    LOG() << "(" << this << ") split (" << dwOffset << " - " << bufferSize << ") ("
                          << 0 << " - " << dwBytes + dwOffset - bufferSize << ")";
                    if (pdwAudioBytes1)
            ...
            {
                ENTER(this, dwNewPosition);
                playCursor = dwNewPosition % std::max<DWORD>(1, bufferSize);
                return DS_OK;
            }
            ...
            STDMETHOD(SetVolume)(LONG lVolume)
            {
                ...
                volume = std::min<LONG>(std::max<LONG>(lVolume, DSBVOLUME_MIN), DSBVOLUME_MAX);
            ...
            STDMETHOD(SetPan)(LONG lPan)
            {
                ...
                if (!(capsFlags & DSBCAPS_CTRLPAN))
                    return DSERR_CONTROLUNAVAIL;
                pan = std::min<LONG>(std::max<LONG>(lPan, DSBPAN_LEFT), DSBPAN_RIGHT);
                CalcVolumeScales();
                return DS_OK;
            }
            STDMETHOD(SetFrequency)(DWORD dwFrequency)
            {
                ENTER(this, dwFrequency);
            ...
            (REFGUID rguidObject, DWORD dwIndex, REFGUID rguidInterface, LPVOID* ppObject)
            {
                ENTER();
                // NYI
                return DSERR_CONTROLUNAVAIL;
            ...
            (DWORD dwPositionNotifies, LPCDSBPOSITIONNOTIFY pcPositionNotifies)
            {
                ...
                numNotifies = 0;
                notifies =
                    (DSBPOSITIONNOTIFY*) malloc(dwPositionNotifies * sizeof(DSBPOSITIONNOTIFY));
                if (!notifies)
                    return DSERR_OUTOFMEMORY;

                memcpy(notifies,
                       pcPositionNotifies,
                       dwPositionNotifies * sizeof(DSBPOSITIONNOTIFY));
            ...
            STDMETHOD(GetAllParameters)(LPDS3DBUFFER pDs3dBuffer)
            {
                DS3DBUFFER b = {sizeof(DS3DBUFFER)};
                *pDs3dBuffer = b;
                return 0;
            }
            STDMETHOD(GetConeAngles)(LPDWORD pdwInsideConeAngle, LPDWORD pdwOutsideConeAngle)
            {
                *pdwInsideConeAngle = 0;
                *pdwOutsideConeAngle = 0;
                return 0;
            }
            STDMETHOD(GetConeOrientation)(D3DVECTOR* pvOrientation)
            {
                D3DVECTOR v = {};
                *pvOrientation = v;
                return 0;
            }
            STDMETHOD(GetConeOutsideVolume)(LPLONG plConeOutsideVolume)
            {
                *plConeOutsideVolume = 0;
                return 0;
            }
            STDMETHOD(GetMaxDistance)(D3DVALUE* pflMaxDistance)
            {
                *pflMaxDistance = 0;
                return 0;
            }
            STDMETHOD(GetMinDistance)(D3DVALUE* pflMinDistance)
            {
                *pflMinDistance = 0;
                return 0;
            }
            STDMETHOD(GetMode)(LPDWORD pdwMode)
            {
                *pdwMode = 0;
                return 0;
            }
            STDMETHOD(GetPosition)(D3DVECTOR* pvPosition)
            {
                D3DVECTOR v = {};
                *pvPosition = v;
                return 0;
            }
            STDMETHOD(GetVelocity)(D3DVECTOR* pvVelocity)
            {
                D3DVECTOR v = {};
                *pvVelocity = v;
                return 0;
            }
            STDMETHOD(SetAllParameters)(LPCDS3DBUFFER pcDs3dBuffer, DWORD dwApply)
            {
                return 0;
            }
            ...
            STDMETHOD(SetConeOrientation)(D3DVALUE x, D3DVALUE y, D3DVALUE z, DWORD dwApply)
            {
                return 0;
            }
            STDMETHOD(SetConeOutsideVolume)(LONG lConeOutsideVolume, DWORD dwApply)
            {
                return 0;
            }
            STDMETHOD(SetMaxDistance)(D3DVALUE flMaxDistance, DWORD dwApply)
            {
                return 0;
            }
            STDMETHOD(SetMinDistance)(D3DVALUE flMinDistance, DWORD dwApply)
            {
                return 0;
            }
            STDMETHOD(SetMode)(DWORD dwMode, DWORD dwApply)
            {
                return 0;
            }
            STDMETHOD(SetPosition)(D3DVALUE x, D3DVALUE y, D3DVALUE z, DWORD dwApply)
            {
                return 0;
            }
            STDMETHOD(SetVelocity)(D3DVALUE x, D3DVALUE y, D3DVALUE z, DWORD dwApply)
            {
                return 0;
            }
        ...
        */
            ...
            static void AdvanceTimeAndMixAll(DWORD ticks)
            {
                ...
                if ((tasflags.emuMode & EMUMODE_NOPLAYBUFFERS) || noDirectSoundOutputAvailable)
                    if (!(tasflags.aviMode & 2))
                        doMix =
                            false; // if muted and not capturing audio, there's no need to mix it

                if (doMix)
                {
                    LOG() << "Current time = " << detTimer.GetTicks();

                    EnterCriticalSection(&s_myMixingOutputBufferCS);

                    static WAVEFORMATEX
                        format; // must be static so wintaser can read it reliably...
                    if (!(s_myMixingOutputBuffer
                          && SUCCEEDED(s_myMixingOutputBuffer->GetFormat(&format,
                                                                         sizeof(WAVEFORMATEX),
                                                                         NULL))))
                    {
                    ...
                    if (contiguousMixOutBufAllocated < contiguousMixOutBufSize + 16)
                    {
                        ...
                        contiguousMixOutBuf =
                            (unsigned char*) realloc(contiguousMixOutBuf,
                                                     contiguousMixOutBufAllocated);
                    }
                    if (contiguousMixOutBufSize)
                        memset(contiguousMixOutBuf,
                               (format.wBitsPerSample <= 8) ? 0x80 : 0,
                               contiguousMixOutBufSize);
                ...
                EnterCriticalSection(&s_soundBufferListCS);
                for (MyBufferList::iterator iter = soundBuffers.begin(); iter != soundBuffers.end();
                     iter++)
                ...
                if (doMix && s_myMixingOutputBuffer)
                {
                    ...
                    if (!tasflags.fastForward)
                    {
                        ...
                        if (write > play
                            && play > write - play) // (don't bother when the math isn't easy)
                            play -= write - play;
                        ...
                        if (contiguousMixOutBufOffset > play && contiguousMixOutBufOffset < write)
                        {
                            ...
                            DWORD waitTime =
                                distFromIdeal * 1000 / contiguousMixOutBufFormat->nAvgBytesPerSec;
                            VERBOSE_LOG()
                                << "WAITING FOR SOUND TO REALIGN (waitTime=" << waitTime
                                << ", offset=" << contiguousMixOutBufOffset << ", play=" << play
                                << ", write=" << write << ", ideal=" << idealPosition << ")";
                            bool notFullSpeed = tasflags.frameAdvanceHeld
                                                || (tasflags.timescale != tasflags.timescaleDivisor)
                                                || (tasflags.aviMode & 1);
                    ...
                    HRESULT hr = s_myMixingOutputBuffer->Lock(contiguousMixOutBufOffset,
                                                              contiguousMixOutBufSize,
                                                              &ptr1,
                                                              &size1,
                                                              &ptr2,
                    ...
                    if (hr == DSBSTATUS_BUFFERLOST)
                    {
                        ...
                        hr = s_myMixingOutputBuffer->Lock(contiguousMixOutBufOffset,
                                                          contiguousMixOutBufSize,
                                                          &ptr1,
                                                          &size1,
                                                          &ptr2,
            ...
            void AdvanceTimeAndMix(DWORD ticks, bool doMix)
            {
                ...
                if (status & DSBSTATUS_PLAYING)
                {
                    ...
                    if (unwrappedPlayCursor < bufferSize)
                    {
                        ...
                        if (doMix)
                            MixFromTo(cursorbase,
                                      playCursor,
                                      0,
                                      contiguousMixOutBufSize,
                                      playCursor
                                          >= ((status & DSBSTATUS_LOOPING) ? allocated : bufferSize)
                        ...
                        if (!(status & DSBSTATUS_LOOPING))
                        {
                            ...
                            if (doMix)
                                MixFromTo(cursorbase,
                                          bufferSize,
                                          0,
                                          contiguousMixOutBufSize * (bufferSize - cursorbase)
                                              / bytes,
                                          true);
                        ...
                        else
                        {
                            ...
                            if (doMix)
                            {
                                ...
                                if (unwrappedPlayCursor + waveformat->nBlockAlign > allocated)
                                {
                                    ...
                                    if (!buffer)
                                    {
                                        DEBUG_LOG() << "FAILED TO ALLOCATE LOOP BUFFER";
                                    }
                                    ReplicateBufferIntoExtraAllocated();
                                    LeaveCriticalSection(&m_bufferCS);
                                }
            ...
            void ReplicateBufferIntoExtraAllocated()
            {
                ...
                for (DWORD copied = bufferSize; copied < allocated; copied += bufferSize)
                    memcpy(buffer + copied, buffer, std::min(bufferSize, allocated - copied));
            }

            void MixFromTo(DWORD pos1,
                           DWORD pos2,
                           DWORD outPos1,
                           DWORD outPos2,
                           bool pos2IsLastSample)
            ...
            {
                volumes.leftVolumeAsScale =
                    (DWORD)(pow(10.0, 0.0005 * (volume + std::min<LONG>(0, -pan))) * 65536.0);
                volumes.rightVolumeAsScale =
                    (DWORD)(pow(10.0, 0.0005 * (volume + std::min<LONG>(0, pan))) * 65536.0);
                LOG() << "volume = " << volume << " -> (" << volumes.leftVolumeAsScale / 65536.0f
                      << ", " << volumes.rightVolumeAsScale / 65536.0f << ")";
            }
            ...
            static void PreSuspend()
            {
                ...
                if (s_myMixingOutputBuffer)
                {
                    LOG() << "setting volume on " << s_myMixingOutputBuffer << " to "
                          << DSBVOLUME_MIN;
        ...
        public:
            ...
            MyDirectSoundBuffer(IDirectSoundBufferN* dsb) : m_dsb(dsb)
            {
                ...
                if (soundBuffers.find(this) == soundBuffers.end())
                    soundBuffers.insert(std::make_pair(this, GetCurrentThreadId()));
                LeaveCriticalSection(&s_soundBufferListCS);
                LOG() << soundBuffers.size() << " sound buffers.";
                tempAudioPtr1 = 0;
                tempAudioSize1 = 0;
                tempAudioPtr2 = 0;
                tempAudioSize2 = 0;
            ...
            (LPDWORD pdwCurrentPlayCursor, LPDWORD pdwCurrentWriteCursor)
            {
                ...
                LOG() << "playCursor=" << (pdwCurrentPlayCursor ? *pdwCurrentPlayCursor : 0)
                      << " writeCursor=" << (pdwCurrentWriteCursor ? *pdwCurrentWriteCursor : 0);
             ...
             DWORD dwFlags)
            {
                while (lockdown)
                    Sleep(1);
                ENTER();
                HRESULT hr = m_dsb->Lock(dwOffset,
                                         dwBytes,
                                         ppvAudioPtr1,
                                         pdwAudioBytes1,
                                         ppvAudioPtr2,
            ...
            STDMETHOD(SetFormat)(LPCWAVEFORMATEX pcfxFormat)
            {
                ...
                ENTER();
                if (pcfxFormat)
                    LOG() << "pcfxFormat = " << pcfxFormat->nChannels << " "
                          << pcfxFormat->nSamplesPerSec << " " << pcfxFormat->wBitsPerSample;
                //WAVEFORMATEX wfmt = {};
                //DWORD bla = 0;
                //this->GetFormat(&wfmt, sizeof(WAVEFORMATEX), &bla);

                if ((tasflags.emuMode & EMUMODE_EMULATESOUND) && s_primaryBufferFormatSet)
                {
                    LOG() << "denied setting format, in case it disagrees with the mixing buffer.";
                    return DS_OK;
                }
            ...
            STDMETHOD(SetVolume)(LONG lVolume)
            {
                ...
                LOG() << "setting volume on " << this << "/" << m_dsb << " to " << lVolume;
            ...
            STDMETHOD(BackDoorAcquireLock)()
            {
                ...
                if (!FAILED(hr))
                    hr =
                        m_dsb->Unlock(tempAudioPtr1, tempAudioSize1, tempAudioPtr2, tempAudioSize2);
                return 0;
            }
            ...
            STDMETHOD(BackDoorResume)()
            {
                ...
                m_dsb->Stop();
                if (this != s_primaryBuffer)
                    m_dsb->SetCurrentPosition(
                        playCursor); // can't remember why I had this disabled before, maybe it sounds bad in some game? it seems correct though
                if (status & DSBSTATUS_PLAYING)
                ...
                LOG() << "setting volume on " << this << "/" << m_dsb << " to " << volume;
            ...
            static void BackDoorStopAll()
            {
                ...
                for (iter = soundBuffers.begin(); iter != soundBuffers.end(); iter++)
                {
                    ...
                    while (status & DSBSTATUS_PLAYING)
                    {
                        ...
                        if (status & DSBSTATUS_PLAYING)
                            DEBUG_LOG() << "WAITING FOR DIRECTSOUND";
                    }
                }
            }
        ...
        template<>
        HRESULT MyDirectSoundBuffer<IDirectSoundBuffer>::SetFX(
            DWORD dwEffectsCount,
            LPDSEFFECTDESC pDSFXDesc,
            LPDWORD pdwResultCodes) IMPOSSIBLE_IMPL template<>
        HRESULT MyDirectSoundBuffer<IDirectSoundBuffer>::AcquireResources(DWORD dwFlags,
                                                                          DWORD dwEffectsCount,
                                                                          LPDWORD pdwResultCodes)
            IMPOSSIBLE_IMPL template<>
            HRESULT MyDirectSoundBuffer<IDirectSoundBuffer>::GetObjectInPath(REFGUID rguidObject,
                                                                             DWORD dwIndex,
            ...
            template<>
            MyDirectSoundBuffer<IDirectSoundBuffer>::MyBufferMap
            MyDirectSoundBuffer<IDirectSoundBuffer>::soundBuffers;
        template<>
        MyDirectSoundBuffer<IDirectSoundBuffer8>::MyBufferMap
            MyDirectSoundBuffer<IDirectSoundBuffer8>::soundBuffers;

        template<typename IDirectSoundN>
        struct IDirectSoundTraits
        {
        };
        template<>
        struct IDirectSoundTraits<IDirectSound>
        {
            enum
            {
                NUMBER = 1
        ...
        template<>
        struct IDirectSoundTraits<IDirectSound8>
        {
            enum
            {
                NUMBER = 8
        ...
        {
        public:
            MyDirectSound(IDirectSoundN* ds)
                : m_ds(ds), m_myMixingOutputBuffer(NULL), m_fallbackRefcount(1)
            {
                LOG() << "MyDirectSound created.";
            ...
            HRESULT STDMETHODCALLTYPE QueryInterface(REFIID riid, void** ppvObj)
            {
                ...
                if (ppvObj)
                {
                    ...
                    {
                        *ppvObj = (IDirectSound*) this;
                        AddRef();
                        return S_OK;
                    }
                    if (IDirectSoundTraits<IDirectSoundN>::NUMBER == 8 && riid == IID_IDirectSound8)
                    {
                        *ppvObj = (IDirectSound8*) this;
                        AddRef();
                        return S_OK;
                    }
                }
                    ...
                    if (riid == IID_IDirectSoundSinkFactory)
                    {
                        if (!s_pEmulatedDirectSoundSinkFactory)
                            s_pEmulatedDirectSoundSinkFactory =
                                new EmulatedDirectSoundSinkFactory();
                        if (s_pEmulatedDirectSoundSinkFactory)
                        {
            ...
            ULONG STDMETHODCALLTYPE Release()
            {
                ...
                if (prevCount == 1)
                {
                    ...
                    if (m_myMixingOutputBuffer)
                    {
                        ...
                        m_myMixingOutputBuffer
                            ->Release(); // this should set s_myMixingOutputBuffer = NULL in the destructor
            ...
            (LPCDSBUFFERDESC pcDSBufferDesc, LPDIRECTSOUNDBUFFER* ppDSBuffer, LPUNKNOWN pUnkOuter)
            {
                ...
                LOG() << "flags=" << pcDSBufferDesc->dwFlags
                      << ", bytes=" << pcDSBufferDesc->dwBufferBytes;

                if (!(pcDSBufferDesc->dwFlags & DSBCAPS_PRIMARYBUFFER)
                    && ((tasflags.emuMode & EMUMODE_EMULATESOUND) || !m_ds))
                {
                    if (!(tasflags.emuMode & EMUMODE_VIRTUALDIRECTSOUND)
                        && !usingVirtualDirectSound)
                    {
                        EnterCriticalSection(&s_myMixingOutputBufferCS);
                        if (!m_myMixingOutputBuffer)
                ...
                {
                    if (pcDSBufferDesc->dwFlags & DSBCAPS_PRIMARYBUFFER)
                        LOG() << "creating s_primaryBuffer with flags=" << pcDSBufferDesc->dwFlags;
                    HRESULT hr =
                        !m_ds ? -1 : m_ds->CreateSoundBuffer(pcDSBufferDesc, ppDSBuffer, pUnkOuter);
                    if (SUCCEEDED(hr))
                    {
                        ...
                        if (pcDSBufferDesc->dwFlags & DSBCAPS_PRIMARYBUFFER)
                        {
                            ...
                            LOG() << "s_primaryBuffer = " << s_primaryBuffer;
                            ...
                            if (tasflags.emuMode & EMUMODE_EMULATESOUND)
                            {
                                ...
                                waveformat.nBlockAlign =
                                    waveformat.wBitsPerSample * waveformat.nChannels / 8;
            ...
            STDMETHOD(GetCaps)(LPDSCAPS pDSCaps)
            {
                ...
                enum
                {
                    defaultCaps = DSCAPS_SECONDARYMONO | DSCAPS_SECONDARYSTEREO
            ...
            {
                ENTER(pDSBufferOriginal);

                if (is_of_type<LPDIRECTSOUNDBUFFER, EmulatedDirectSoundBuffer*>(pDSBufferOriginal))
                {
                    LOG() << "pDSBufferOriginal=" << pDSBufferOriginal << ", version=emulated";
                    *ppDSBufferDuplicate = EmulatedDirectSoundBuffer::Duplicate(
                        (EmulatedDirectSoundBuffer*) pDSBufferOriginal);
                    return DS_OK;
                }
                ...
                bool hookIt = true;
                if (is_of_type<LPDIRECTSOUNDBUFFER, MyDirectSoundBuffer<IDirectSoundBuffer8>*>(
                        pDSBufferOriginal))
                {
                    pDSBufferOriginal =
                        ((MyDirectSoundBuffer<IDirectSoundBuffer8>*) pDSBufferOriginal)->m_dsb;
                    LOG() << "pDSBufferOriginal=" << pDSBufferOriginal << ", version=8";
                }
                else if (is_of_type<LPDIRECTSOUNDBUFFER, MyDirectSoundBuffer<IDirectSoundBuffer>*>(
                             pDSBufferOriginal))
                {
                    pDSBufferOriginal =
                        ((MyDirectSoundBuffer<IDirectSoundBuffer>*) pDSBufferOriginal)->m_dsb;
                    LOG() << "pDSBufferOriginal=" << pDSBufferOriginal << ", version=1";
                }
                else
                {
                    LOG() << "pDSBufferOriginal=" << pDSBufferOriginal << ", version=raw";
                    hookIt = false;
                }
            ...
            void CreateMyMixingOutputSoundBuffer(/*LPCDSBUFFERDESC pcDSBufferDesc*/)
            {
                ...
                waveformat.nSamplesPerSec = tasflags.audioFrequency;
                waveformat.wBitsPerSample = tasflags.audioBitsPerSecond;
                LOG() << "mixing format: " << waveformat.nSamplesPerSec << " "
                ...
                desc.dwFlags =
                    ...
                    | DSBCAPS_GLOBALFOCUS /*| (tasflags.forceSoftware ? DSBCAPS_LOCSOFTWARE : 0)*/;
                desc.dwBufferBytes = waveformat.nAvgBytesPerSec / 6; // 0.167 second buffer
                desc.lpwfxFormat = &waveformat;

                LOG() << "creating m_myMixingOutputBuffer (m was " << m_myMixingOutputBuffer
                      << ", s was " << s_myMixingOutputBuffer << ")";
                EnterCriticalSection(&s_myMixingOutputBufferCS);
                ...
                if (SUCCEEDED(hr))
                {
                    HookCOMInterface(IID_IDirectSoundBuffer,
                                     (LPVOID*) &m_myMixingOutputBuffer,
                                     true);
                    s_myMixingOutputBuffer = m_myMixingOutputBuffer;
                    LOG() << "s_myMixingOutputBuffer = " << s_myMixingOutputBuffer;

                    // make sure buffer is initially empty (silence), just in case the documentation is telling the truth for once
                    unsigned char* bufPtr1;
                    DWORD bufSize1;
                    if (SUCCEEDED(m_myMixingOutputBuffer->Lock(0,
                                                               desc.dwBufferBytes,
                                                               (LPVOID*) &bufPtr1,
                                                               &bufSize1,
                                                               NULL,
        ...
        template<>
        HRESULT MyDirectSound<IDirectSound>::VerifyCertification(LPDWORD pdwCertified)
            IMPOSSIBLE_IMPL template<>
            IDirectSound* MyDirectSound<IDirectSound>::m_freeDS = NULL;
        template<>
        IDirectSound8* MyDirectSound<IDirectSound8>::m_freeDS = NULL;
        ...
        struct MyDirectMusicPerformance
        {
            ...
            static HRESULT(STDMETHODCALLTYPE* QueryInterface)(IDirectMusicPerformanceN* pThis,
                                                              REFIID riid,
                                                              void** ppvObj);
            static HRESULT STDMETHODCALLTYPE MyQueryInterface(IDirectMusicPerformanceN* pThis,
                                                              REFIID riid,
                                                              void** ppvObj)
            {
                ENTER();
            ...
            static HRESULT(STDMETHODCALLTYPE* Init)(IDirectMusicPerformanceN* pThis,
                                                    IDirectMusic** ppDirectMusic,
                                                    LPDIRECTSOUND pDirectSound,
                                                    HWND hWnd);
            static HRESULT STDMETHODCALLTYPE MyInit(IDirectMusicPerformanceN* pThis,
                                                    IDirectMusic** ppDirectMusic,
                                                    LPDIRECTSOUND pDirectSound,
                                                    HWND hWnd)
            {
            ...
            static HRESULT(STDMETHODCALLTYPE* InitAudio)(IDirectMusicPerformanceN* pThis,
                                                         IDirectMusic** ppDirectMusic,
            ...
            static HRESULT STDMETHODCALLTYPE MyInitAudio(IDirectMusicPerformanceN* pThis,
                                                         IDirectMusic** ppDirectMusic,
                                                         IDirectSound** ppDirectSound,
                                                         HWND hWnd,
                                                         DWORD dwDefaultPathType,
        ...
        template<>
        BOOL MyDirectMusicPerformance<IDirectMusicPerformance>::Hook(IDirectMusicPerformance* obj)
        {
            BOOL rv = FALSE;
...
#define DEF(x)                                                                             \
    template<>                                                                             \
    HRESULT(STDMETHODCALLTYPE* MyDirectMusicPerformance<struct x>::QueryInterface)         \
    (x * pThis, REFIID riid, void** ppvObj) = 0;                                           \
    template<>                                                                             \
    HRESULT(STDMETHODCALLTYPE* MyDirectMusicPerformance<struct x>::Init)                   \
    (x * pThis, IDirectMusic * *ppDirectMusic, LPDIRECTSOUND pDirectSound, HWND hWnd) = 0; \
    template<>                                                                             \
    HRESULT(STDMETHODCALLTYPE* MyDirectMusicPerformance<struct x>::InitAudio)              \
    (x * pThis,                                                                            \
     IDirectMusic * *ppDirectMusic,                                                        \
     IDirectSound * *ppDirectSound,                                                        \
     HWND hWnd,                                                                            \
...
#undef DEF
        ...
        struct MyDirectMusic
        {
            ...
            static HRESULT(STDMETHODCALLTYPE* QueryInterface)(IDirectMusicN* pThis,
                                                              REFIID riid,
                                                              void** ppvObj);
            static HRESULT STDMETHODCALLTYPE MyQueryInterface(IDirectMusicN* pThis,
                                                              REFIID riid,
                                                              void** ppvObj)
            {
                ENTER();
            ...
            static HRESULT(STDMETHODCALLTYPE* GetMasterClock)(IDirectMusicN* pThis,
                                                              LPGUID pguidClock,
                                                              IReferenceClock** ppReferenceClock);
            static HRESULT STDMETHODCALLTYPE MyGetMasterClock(IDirectMusicN* pThis,
                                                              LPGUID pguidClock,
                                                              IReferenceClock** ppReferenceClock)
            {
            ...
            static HRESULT(STDMETHODCALLTYPE* SetMasterClock)(IDirectMusicN* pThis,
                                                              REFGUID rguidClock);
            static HRESULT STDMETHODCALLTYPE MySetMasterClock(IDirectMusicN* pThis,
                                                              REFGUID rguidClock)
            {
                ENTER();
...
#define DEF(x)                                                               \
    template<>                                                               \
    HRESULT(STDMETHODCALLTYPE* MyDirectMusic<struct x>::QueryInterface)      \
    (x * pThis, REFIID riid, void** ppvObj) = 0;                             \
    template<>                                                               \
    HRESULT(STDMETHODCALLTYPE* MyDirectMusic<struct x>::GetMasterClock)      \
    (x * pThis, LPGUID pguidClock, IReferenceClock * *ppReferenceClock) = 0; \
    template<>                                                               \
    HRESULT(STDMETHODCALLTYPE* MyDirectMusic<struct x>::SetMasterClock)      \
    (x * pThis, REFGUID rguidClock) = 0;
        DEF(IDirectMusic)
        DEF(IDirectMusic2)
        DEF(IDirectMusic8)
#undef DEF
        ...
        struct MyMediaFilter
        {
            ...
            static HRESULT(STDMETHODCALLTYPE* QueryInterface)(IMediaFilter* pThis,
                                                              REFIID riid,
                                                              void** ppvObj);
            static HRESULT STDMETHODCALLTYPE MyQueryInterface(IMediaFilter* pThis,
                                                              REFIID riid,
                                                              void** ppvObj)
            {
                ENTER(riid.Data1);
            ...
            static HRESULT(STDMETHODCALLTYPE* SetSyncSource)(IMediaFilter* pThis,
                                                             IReferenceClock* pClock);
            static HRESULT STDMETHODCALLTYPE MySetSyncSource(IMediaFilter* pThis,
                                                             IReferenceClock* pClock)
            {
                ENTER(pClock);
                if (pClock)
        ...
        HRESULT(STDMETHODCALLTYPE* MyMediaFilter::QueryInterface)
        (IMediaFilter* pThis, REFIID riid, void** ppvObj) = 0;
        //HRESULT (STDMETHODCALLTYPE* MyMediaFilter::GetSyncSource)(IMediaFilter* pThis, IReferenceClock** pClock) = 0;
        HRESULT(STDMETHODCALLTYPE* MyMediaFilter::SetSyncSource)
        (IMediaFilter* pThis, IReferenceClock* pClock) = 0;
...
#define INTERFACE IDirectSoundSinkFactory
        DECLARE_INTERFACE_(IDirectSoundSinkFactory, IUnknown)
        {
            ...
            STDMETHOD(CreateSoundSink)
            (THIS_ LPWAVEFORMATEX lpWaveFormat, struct IDirectSoundSink * *ppDSC) PURE;
        };
...
#define INTERFACE IDirectSoundSink
        DECLARE_INTERFACE_(IDirectSoundSink, IUnknown)
        {
            ...
            STDMETHOD(CreateSoundBuffer)
            (THIS_ const LPDSBUFFERDESC pcDSBufferDesc,
             LPDWORD,
             DWORD,
             REFGUID rguid,
             IDirectSoundBuffer** ppDSBuffer) PURE;
            ...
            STDMETHOD(GetSoundBufferBusIDs)
            (THIS_ IDirectSoundBuffer*, LPDWORD, LPDWORD, LPDWORD) PURE;
        };
...
#define INTERFACE IDirectSoundSinkSync
        DECLARE_INTERFACE_(IDirectSoundSinkSync, IUnknown)
        {
            ...
            STDMETHOD(GetFormat)
            (LPWAVEFORMATEX lpwfxFormat, DWORD dwSizeAllocated, LPDWORD lpdwSizeWritten) PURE;
        };
...
#define INTERFACE IKsControl
        ...
        struct EmulatedDirectSoundSink : public IDirectSoundSink,
                                         public IDirectSoundSinkSync,
                                         public IKsControl
        {
        public:
            ...
            HRESULT STDMETHODCALLTYPE QueryInterface(REFIID riid, void** ppvObj)
            {
                ...
                {
                    DEBUG_LOG() << " unknown riid: " << riid.Data1 << "-" << riid.Data2 << "-"
                                << riid.Data3 << "-" << riid.Data4[0] << riid.Data4[1]
            ...
            STDMETHOD(CreateSoundBuffer)
            (const LPDSBUFFERDESC pcDSBufferDesc,
             LPDWORD lpdwNotSure,
             DWORD dwNumSlotsOrSomething,
             REFGUID rguid,
            ...
            STDMETHOD(GetSoundBufferBusIDs)
            (IDirectSoundBuffer* lpDSB, LPDWORD a, LPDWORD b, LPDWORD c)
            {
                ENTER(this, lpDSB, a, b, c);
            ...
            STDMETHOD(GetFormat)
            (LPWAVEFORMATEX lpwfxFormat, DWORD dwSizeAllocated, LPDWORD lpdwSizeWritten)
            {
                ENTER(this);
        ...
        struct EmulatedDirectSoundSinkFactory* s_pEmulatedDirectSoundSinkFactory =
            NULL; // for now, we only need 1 of these
        ...
        public:
            ...
            // IDirectSoundSinkFactory? methods
            HRESULT STDMETHODCALLTYPE CreateSoundSink(LPWAVEFORMATEX lpWaveFormat,
                                                      IDirectSoundSink** ppDSC)
            {
                ENTER(this);
                if (!ppDSC)
                    return E_POINTER;
    ...
    namespace WinSound
    {
        using Log = DebugLog<LogCategory::WSOUND>;
        ...
        HOOK_FUNCTION(MMRESULT,
                      ...
                      DWORD fdwOpen);
        HOOKFUNC MMRESULT WINAPI MywaveOutOpen(LPHWAVEOUT phwo,
                                               UINT uDeviceID,
                                               LPCWAVEFORMATEX pwfx,
                                               DWORD_PTR dwCallback,
                                               DWORD_PTR dwInstance,
        ...
        HOOKFUNC MMRESULT WINAPI MywaveOutGetPosition(HWAVEOUT hwo, LPMMTIME pmmt, UINT cbmmt)
        {
            ...
            LOG() << "type=" << pmmt->wType << ", value=" << pmmt->u.cb;

            DWORD timeDiff = detTimer.GetTicks(TIMETYPE_GETTICKCOUNT) - waveOutBaseTime;
            pmmt->wType = TIME_BYTES;
            pmmt->u.cb = (timeDiff * waveOutWaveFormat.nSamplesPerSec / 1000)
                         * waveOutWaveFormat.nBlockAlign;

            return rv;
        }

        HOOK_FUNCTION(MCIERROR,
                      WINAPI,
                      mciSendCommandA,
                      MCIDEVICEID mciId,
                      UINT uMsg,
                      DWORD_PTR dwParam1,
                      DWORD_PTR dwParam2);
        HOOKFUNC MCIERROR WINAPI MymciSendCommandA(MCIDEVICEID mciId,
                                                   UINT uMsg,
                                                   DWORD_PTR dwParam1,
                                                   DWORD_PTR dwParam2)
        {
        ...
        HOOK_FUNCTION(MCIERROR,
                      ...
                      DWORD_PTR dwParam1,
                      DWORD_PTR dwParam2);
        HOOKFUNC MCIERROR WINAPI MymciSendCommandW(MCIDEVICEID mciId,
                                                   UINT uMsg,
                                                   DWORD_PTR dwParam1,
                                                   DWORD_PTR dwParam2)
        {
    ...
    namespace DirectSound
    {
        HOOK_FUNCTION(HRESULT,
                      ...
                      LPDIRECTSOUND* ppDS,
                      LPUNKNOWN pUnkOuter);
        HOOKFUNC HRESULT WINAPI MyDirectSoundCreate(LPCGUID pcGuidDevice,
                                                    LPDIRECTSOUND* ppDS,
                                                    LPUNKNOWN pUnkOuter)
        {
            ENTER();
                ...
                if (FAILED(rv))
                {
                    if (!(tasflags.emuMode & EMUMODE_VIRTUALDIRECTSOUND))
                        LOG() << "DirectSoundCreate FAILED"
                              << (tasflags.threadMode ? ", all on its own"
                                                      : ", because multithreading is disabled");
        ...
        HOOK_FUNCTION(HRESULT,
                      ...
                      LPDIRECTSOUND8* ppDS,
                      LPUNKNOWN pUnkOuter);
        HOOKFUNC HRESULT WINAPI MyDirectSoundCreate8(LPCGUID pcGuidDevice,
                                                     LPDIRECTSOUND8* ppDS,
                                                     LPUNKNOWN pUnkOuter)
        {
            ENTER();
        ...
        HOOK_FUNCTION(HRESULT,
                      ...
                      LPVOID pContext);
        HOOKFUNC HRESULT WINAPI MyDirectSoundEnumerateA(LPDSENUMCALLBACKA pDSEnumCallback,
                                                        LPVOID pContext)
        {
            ENTER();
        ...
        HOOK_FUNCTION(HRESULT,
                      ...
                      LPVOID pContext);
        HOOKFUNC HRESULT WINAPI MyDirectSoundEnumerateW(LPDSENUMCALLBACKW pDSEnumCallback,
                                                        LPVOID pContext)
        {
            ENTER();
        ...
        HOOK_FUNCTION(HRESULT,
                      ...
                      LPDSENUMCALLBACKA pDSEnumCallback,
                      LPVOID pContext);
        HOOKFUNC HRESULT WINAPI MyDirectSoundCaptureEnumerateA(LPDSENUMCALLBACKA pDSEnumCallback,
                                                               LPVOID pContext)
        {
            ENTER();
        ...
        HOOK_FUNCTION(HRESULT,
                      ...
                      LPDSENUMCALLBACKW pDSEnumCallback,
                      LPVOID pContext);
        HOOKFUNC HRESULT WINAPI MyDirectSoundCaptureEnumerateW(LPDSENUMCALLBACKW pDSEnumCallback,
                                                               LPVOID pContext)
        {
            ENTER();
        ...
        {
            bool applicable =
                ((tasflags.emuMode & EMUMODE_VIRTUALDIRECTSOUND) || usingVirtualDirectSound);
