...
DEFINE_LOCAL_GUID(IID_IDirect3D9,
                  0x81BDCBCA,
                  0x64D4,
                  0x426D,
                  0xAE,
                  ...
                  0x27,
                  0x5C);
DEFINE_LOCAL_GUID(IID_IDirect3DDevice9,
                  0xD0223B96,
                  0xBF7A,
                  0x43FD,
                  0x92,
                  ...
                  0xB9,
                  0xEB);
DEFINE_LOCAL_GUID(IID_IDirect3DSwapChain9,
                  0x794950F2,
                  0xADFC,
                  0x458A,
                  0x90,
                  ...
                  0x50,
                  0x3B);
DEFINE_LOCAL_GUID(IID_IDirect3DSurface9,
                  0x0CFBAF3A,
                  0x9FF6,
                  0x429A,
                  0x99,
                  ...
                  0xB8,
                  0x9B);
DEFINE_LOCAL_GUID(IID_IDirect3DTexture9,
                  0x85C31227,
                  0x3DE5,
                  0x4F00,
                  0x9B,
                  ...
                  0x18,
                  0xB5);
DEFINE_LOCAL_GUID(IID_IDirect3D9Ex,
                  0x02177241,
                  0x69FC,
                  0x400C,
                  0x8F,
                  ...
                  0x86,
                  0x1D);
DEFINE_LOCAL_GUID(IID_IDirect3DDevice9Ex,
                  0xB18B10CE,
                  0x2649,
                  0x405A,
                  0x87,
                  ...
                  0x31,
                  0x3A);
DEFINE_LOCAL_GUID(IID_IDirect3DSwapChain9Ex,
                  0x91886CAF,
                  0x1C3D,
                  0x4D2E,
                  0xA0,
...
namespace Hooks
{
    ...
    static void ProcessPresentationParams9(D3DPRESENT_PARAMETERS* pPresentationParameters,
                                           IDirect3D9* d3d,
                                           IDirect3DDevice9* d3dDevice)
    {
        if (pPresentationParameters) // presentparams
        {
            pPresentationParameters->Flags |=
                D3DPRESENTFLAG_LOCKABLE_BACKBUFFER; // back buffer must be lockable, to allow for AVI recording
    ...
    struct MyDirect3DDevice9
    {
        ...
        static ULONG STDMETHODCALLTYPE MyRelease(IDirect3DDevice9* pThis)
        {
            ...
            if (rv == 0)
            {
                ...
                if (s_saved_d3d9Device == pThis)
                {
                    s_saved_d3d9Device = NULL;
                }
            }
            return rv;
        }

        static HRESULT(STDMETHODCALLTYPE* QueryInterface)(IDirect3DDevice9* pThis,
                                                          REFIID riid,
                                                          void** ppvObj);
        static HRESULT STDMETHODCALLTYPE MyQueryInterface(IDirect3DDevice9* pThis,
                                                          REFIID riid,
                                                          void** ppvObj)
        {
            ENTER();
        ...
        static HRESULT(STDMETHODCALLTYPE* Reset)(IDirect3DDevice9* pThis,
                                                 D3DPRESENT_PARAMETERS* pPresentationParameters);
        static HRESULT STDMETHODCALLTYPE MyReset(IDirect3DDevice9* pThis,
                                                 D3DPRESENT_PARAMETERS* pPresentationParameters)
        {
            ENTER();
        ...
        static void PresentFrameBoundary(IDirect3DDevice9* pThis)
        {
            ...
            else
            {
                ...
                if (!pSurface)
                {
                    ...
                    if (SUCCEEDED(pThis->CreateOffscreenPlainSurface(d3ddesc.Width,
                                                                     d3ddesc.Height,
                                                                     d3ddesc.Format,
                                                                     D3DPOOL_SYSTEMMEM,
                                                                     &pBackBufCopy,
        ...
        static HRESULT(STDMETHODCALLTYPE* Present)(IDirect3DDevice9* pThis,
                                                   CONST RECT* pSourceRect,
                                                   CONST RECT* pDestRect,
                                                   HWND hDestWindowOverride,
                                                   CONST RGNDATA* pDirtyRegion);
        static HRESULT STDMETHODCALLTYPE MyPresent(IDirect3DDevice9* pThis,
                                                   CONST RECT* pSourceRect,
                                                   CONST RECT* pDestRect,
                                                   HWND hDestWindowOverride,
                                                   CONST RGNDATA* pDirtyRegion)
        {
            ...
            if ((d3d9BackBufActive || d3d9BackBufDirty) && !redrawingScreen)
            {
                ...
                if (pSourceRect)
                    s_savedD3D9SrcRect = *pSourceRect;
                if (pDestRect)
                    s_savedD3D9DstRect = *pDestRect;
                s_savedD3D9HWND =
                    hDestWindowOverride ? hDestWindowOverride : s_savedD3D9DefaultHWND;
        ...
        static HRESULT(STDMETHODCALLTYPE* GetSwapChain)(IDirect3DDevice9* pThis,
                                                        UINT iSwapChain,
                                                        IDirect3DSwapChain9** pSwapChain);
        static HRESULT STDMETHODCALLTYPE MyGetSwapChain(IDirect3DDevice9* pThis,
                                                        UINT iSwapChain,
                                                        IDirect3DSwapChain9** pSwapChain)
        {
            ENTER(iSwapChain);
        ...
        MyCreateAdditionalSwapChain(IDirect3DDevice9* pThis,
                                    D3DPRESENT_PARAMETERS* pPresentationParameters,
                                    IDirect3DSwapChain9** pSwapChain)
        {
            ENTER();
        ...
        static HRESULT(STDMETHODCALLTYPE* SetRenderTarget)(IDirect3DDevice9* pThis,
                                                           DWORD RenderTargetIndex,
                                                           IDirect3DSurface9* pRenderTarget);
        static HRESULT STDMETHODCALLTYPE MySetRenderTarget(IDirect3DDevice9* pThis,
                                                           DWORD RenderTargetIndex,
                                                           IDirect3DSurface9* pRenderTarget)
        {
        ...
        static HRESULT(STDMETHODCALLTYPE* GetRenderTarget)(IDirect3DDevice9* pThis,
                                                           DWORD RenderTargetIndex,
                                                           IDirect3DSurface9** ppRenderTarget);
        static HRESULT STDMETHODCALLTYPE MyGetRenderTarget(IDirect3DDevice9* pThis,
                                                           DWORD RenderTargetIndex,
                                                           IDirect3DSurface9** ppRenderTarget)
        {
        ...
        static void Lock(IDirect3DDevice9* pThis,
                         DDSURFACEDESC& desc,
                         IDirect3DSurface9*& pBackBuffer,
        ...
        static HRESULT(STDMETHODCALLTYPE* Clear)(IDirect3DDevice9* pThis,
                                                 DWORD Count,
                                                 ...
                                                 float Z,
                                                 DWORD Stencil);
        static HRESULT STDMETHODCALLTYPE MyClear(IDirect3DDevice9* pThis,
                                                 DWORD Count,
                                                 CONST D3DRECT* pRects,
                                                 DWORD Flags,
                                                 D3DCOLOR Color,
        ...
        static HRESULT(STDMETHODCALLTYPE* DrawPrimitive)(IDirect3DDevice9* pThis,
                                                         D3DPRIMITIVETYPE PrimitiveType,
                                                         UINT StartVertex,
                                                         UINT PrimitiveCount);
        static HRESULT STDMETHODCALLTYPE MyDrawPrimitive(IDirect3DDevice9* pThis,
                                                         D3DPRIMITIVETYPE PrimitiveType,
                                                         UINT StartVertex,
                                                         UINT PrimitiveCount)
        {
        ...
        static HRESULT(STDMETHODCALLTYPE* DrawIndexedPrimitive)(IDirect3DDevice9* pThis,
                                                                D3DPRIMITIVETYPE primitiveType,
                                                                INT baseVertexIndex,
                                                                UINT minIndex,
                                                                UINT NumVertices,
                                                                UINT startIndex,
                                                                UINT primCount);
        static HRESULT STDMETHODCALLTYPE MyDrawIndexedPrimitive(IDirect3DDevice9* pThis,
                                                                D3DPRIMITIVETYPE primitiveType,
                                                                INT baseVertexIndex,
                                                                UINT minIndex,
                                                                UINT NumVertices,
        ...
        static HRESULT(STDMETHODCALLTYPE* DrawPrimitiveUP)(IDirect3DDevice9* pThis,
                                                           D3DPRIMITIVETYPE PrimitiveType,
                                                           UINT PrimitiveCount,
                                                           CONST void* pVertexStreamZeroData,
                                                           UINT VertexStreamZeroStride);
        static HRESULT STDMETHODCALLTYPE MyDrawPrimitiveUP(IDirect3DDevice9* pThis,
                                                           D3DPRIMITIVETYPE PrimitiveType,
                                                           UINT PrimitiveCount,
                                                           CONST void* pVertexStreamZeroData,
                                                           UINT VertexStreamZeroStride)
        ...
        static HRESULT(STDMETHODCALLTYPE* DrawIndexedPrimitiveUP)(IDirect3DDevice9* pThis,
                                                                  D3DPRIMITIVETYPE PrimitiveType,
                                                                  UINT MinVertexIndex,
                                                                  ...
                                                                  CONST void* pVertexStreamZeroData,
                                                                  UINT VertexStreamZeroStride);
        static HRESULT STDMETHODCALLTYPE MyDrawIndexedPrimitiveUP(IDirect3DDevice9* pThis,
                                                                  D3DPRIMITIVETYPE PrimitiveType,
                                                                  UINT MinVertexIndex,
                                                                  UINT NumVertexIndices,
                                                                  UINT PrimitiveCount,
        ...
        static HRESULT(STDMETHODCALLTYPE* CreateTexture)(IDirect3DDevice9* pThis,
                                                         UINT Width,
                                                         UINT Height,
                                                         UINT Levels,
                                                         DWORD Usage,
        ...
        static HRESULT STDMETHODCALLTYPE MyCreateTexture(IDirect3DDevice9* pThis,
                                                         UINT Width,
                                                         UINT Height,
                                                         UINT Levels,
                                                         DWORD Usage,
        ...
        {
            ENTER(Width, Height);
            HRESULT rv = CreateTexture(pThis,
                                       Width,
                                       Height,
                                       Levels,
                                       Usage,
            ...
            if (SUCCEEDED(rv))
            {
                ...
                for (int i = 0; i < numLevels; i++)
                {
                    ...
                    {
                        HookCOMInterface(IID_IDirect3DSurface9,
        ...
        static HRESULT(STDMETHODCALLTYPE* CreateRenderTarget)(IDirect3DDevice9* pThis,
                                                              UINT Width,
                                                              UINT Height,
                                                              D3DFORMAT Format,
                                                              ...
                                                              HANDLE* pSharedHandle);
        static HRESULT STDMETHODCALLTYPE MyCreateRenderTarget(IDirect3DDevice9* pThis,
                                                              UINT Width,
                                                              UINT Height,
                                                              D3DFORMAT Format,
                                                              D3DMULTISAMPLE_TYPE MultiSample,
                                                              ...
                                                              HANDLE* pSharedHandle)
        {
            ENTER(Width, Height);
            Lockable = TRUE;
            HRESULT rv = CreateRenderTarget(pThis,
                                            Width,
                                            Height,
                                            Format,
                                            MultiSample,
    ...
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::QueryInterface)
    (IDirect3DDevice9* pThis, REFIID riid, void** ppvObj) = 0;
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::Present)
    (IDirect3DDevice9* pThis,
     CONST RECT* pSourceRect,
     CONST RECT* pDestRect,
     HWND hDestWindowOverride,
     CONST RGNDATA* pDirtyRegion) = 0;
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::Reset)
    (IDirect3DDevice9* pThis, D3DPRESENT_PARAMETERS* pPresentationParameters) = 0;
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::GetSwapChain)
    (IDirect3DDevice9* pThis, UINT iSwapChain, IDirect3DSwapChain9** pSwapChain) = 0;
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::CreateAdditionalSwapChain)
    (IDirect3DDevice9* pThis,
     D3DPRESENT_PARAMETERS* pPresentationParameters,
     IDirect3DSwapChain9** pSwapChain) = 0;
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::SetRenderTarget)
    (IDirect3DDevice9* pThis, DWORD RenderTargetIndex, IDirect3DSurface9* pRenderTarget) = 0;
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::GetRenderTarget)
    (IDirect3DDevice9* pThis, DWORD RenderTargetIndex, IDirect3DSurface9** ppRenderTarget) = 0;
    ...
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::DrawIndexedPrimitive)
    (IDirect3DDevice9* pThis,
     D3DPRIMITIVETYPE primitiveType,
     INT baseVertexIndex,
     UINT minIndex,
     ...
     UINT startIndex,
     UINT primCount) = 0;
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::Clear)
    (IDirect3DDevice9* pThis,
     DWORD Count,
     CONST D3DRECT* pRects,
     DWORD Flags,
     ...
     float Z,
     DWORD Stencil) = 0;
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::DrawPrimitive)
    (IDirect3DDevice9* pThis,
     D3DPRIMITIVETYPE PrimitiveType,
     UINT StartVertex,
     UINT PrimitiveCount) = 0;
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::DrawPrimitiveUP)
    (IDirect3DDevice9* pThis,
     D3DPRIMITIVETYPE PrimitiveType,
     UINT PrimitiveCount,
     CONST void* pVertexStreamZeroData,
     UINT VertexStreamZeroStride) = 0;
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::DrawIndexedPrimitiveUP)
    (IDirect3DDevice9* pThis,
     D3DPRIMITIVETYPE PrimitiveType,
     UINT MinVertexIndex,
     UINT NumVertexIndices,
    ...
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::CreateTexture)
    (IDirect3DDevice9* pThis,
     UINT Width,
     UINT Height,
     UINT Levels,
    ...
    HRESULT(STDMETHODCALLTYPE* MyDirect3DDevice9::CreateRenderTarget)
    (IDirect3DDevice9* pThis,
     UINT Width,
     UINT Height,
     D3DFORMAT Format,
    ...
    struct MyDirect3DSwapChain9
    {
        ...
        static ULONG STDMETHODCALLTYPE MyRelease(IDirect3DSwapChain9* pThis)
        {
            ...
            if (rv == 0)
            {
                if (s_saved_d3d9SwapChain == pThis)
                {
                    s_saved_d3d9SwapChain = NULL;
                }
            }
        ...
        static HRESULT(STDMETHODCALLTYPE* QueryInterface)(IDirect3DSwapChain9* pThis,
                                                          REFIID riid,
                                                          void** ppvObj);
        static HRESULT STDMETHODCALLTYPE MyQueryInterface(IDirect3DSwapChain9* pThis,
                                                          REFIID riid,
                                                          void** ppvObj)
        {
            ENTER();
        ...
        static HRESULT(STDMETHODCALLTYPE* Present)(IDirect3DSwapChain9* pThis,
                                                   CONST RECT* pSourceRect,
                                                   CONST RECT* pDestRect,
                                                   HWND hDestWindowOverride,
                                                   CONST RGNDATA* pDirtyRegion,
                                                   DWORD dwFlags);
        static HRESULT STDMETHODCALLTYPE MyPresent(IDirect3DSwapChain9* pThis,
                                                   CONST RECT* pSourceRect,
                                                   CONST RECT* pDestRect,
                                                   HWND hDestWindowOverride,
                                                   CONST RGNDATA* pDirtyRegion,
    ...
    HRESULT(STDMETHODCALLTYPE* MyDirect3DSwapChain9::QueryInterface)
    (IDirect3DSwapChain9* pThis, REFIID riid, void** ppvObj) = 0;
    HRESULT(STDMETHODCALLTYPE* MyDirect3DSwapChain9::Present)
    (IDirect3DSwapChain9* pThis,
     CONST RECT* pSourceRect,
     CONST RECT* pDestRect,
     HWND hDestWindowOverride,
     CONST RGNDATA* pDirtyRegion,
    ...
    struct MyDirect3DSurface9
    {
        ...
        static HRESULT(STDMETHODCALLTYPE* SetPrivateData)(IDirect3DSurface9* pThis,
                                                          REFGUID refguid,
                                                          CONST void* pData,
                                                          DWORD SizeOfData,
                                                          DWORD Flags);
        static HRESULT STDMETHODCALLTYPE MySetPrivateData(IDirect3DSurface9* pThis,
                                                          REFGUID refguid,
                                                          CONST void* pData,
                                                          DWORD SizeOfData,
                                                          DWORD Flags)
        ...
        static HRESULT(STDMETHODCALLTYPE* FreePrivateData)(IDirect3DSurface9* pThis,
                                                           REFGUID refguid);
        static HRESULT STDMETHODCALLTYPE MyFreePrivateData(IDirect3DSurface9* pThis,
                                                           REFGUID refguid)
        {
        ...
        static HRESULT(STDMETHODCALLTYPE* QueryInterface)(IDirect3DSurface9* pThis,
                                                          REFIID riid,
                                                          void** ppvObj);
        static HRESULT STDMETHODCALLTYPE MyQueryInterface(IDirect3DSurface9* pThis,
                                                          REFIID riid,
                                                          void** ppvObj)
        {
            ENTER(riid.Data1);
...
#define DEF(x, IMPL_ID)                                                                 \
    ...
    HRESULT(STDMETHODCALLTYPE* MyDirect3DSurface9<IMPL_ID>::QueryInterface)             \
    (x * pThis, REFIID riid, void** ppvObj) = 0;                                        \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DSurface9<IMPL_ID>::UnlockRect)(x * pThis) = 0; \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DSurface9<IMPL_ID>::SetPrivateData)             \
    (x * pThis, REFGUID refguid, CONST void* pData, DWORD SizeOfData, DWORD Flags) = 0; \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DSurface9<IMPL_ID>::FreePrivateData)            \
...
#undef HRESULT
    ...
    struct MyDirect3DTexture9
    {
        ...
        static HRESULT(STDMETHODCALLTYPE* SetPrivateData)(IDirect3DTexture9* pThis,
                                                          REFGUID refguid,
                                                          CONST void* pData,
                                                          DWORD SizeOfData,
                                                          DWORD Flags);
        static HRESULT STDMETHODCALLTYPE MySetPrivateData(IDirect3DTexture9* pThis,
                                                          REFGUID refguid,
                                                          CONST void* pData,
                                                          DWORD SizeOfData,
                                                          DWORD Flags)
        ...
        static HRESULT(STDMETHODCALLTYPE* FreePrivateData)(IDirect3DTexture9* pThis,
                                                           REFGUID refguid);
        static HRESULT STDMETHODCALLTYPE MyFreePrivateData(IDirect3DTexture9* pThis,
                                                           REFGUID refguid)
        {
            HRESULT hr = FreePrivateData(pThis, refguid);
            ENTER(pThis);
        ...
        static HRESULT(STDMETHODCALLTYPE* QueryInterface)(IDirect3DTexture9* pThis,
                                                          REFIID riid,
                                                          void** ppvObj);
        static HRESULT STDMETHODCALLTYPE MyQueryInterface(IDirect3DTexture9* pThis,
                                                          REFIID riid,
                                                          void** ppvObj)
        {
            ENTER(riid.Data1);
...
#define DEF(x)                                                                          \
    ...
    HRESULT(STDMETHODCALLTYPE* MyDirect3DTexture9::QueryInterface)                      \
    (x * pThis, REFIID riid, void** ppvObj) = 0;                                        \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DTexture9::UnlockRect)(x * pThis, UINT) = 0;    \
    HRESULT(STDMETHODCALLTYPE* MyDirect3DTexture9::SetPrivateData)                      \
    (x * pThis, REFGUID refguid, CONST void* pData, DWORD SizeOfData, DWORD Flags) = 0; \
...
#undef HRESULT
    ...
    void BackupVideoMemoryOfAllD3D9Surfaces()
    {
        ...
        if (d3d9BackBufDirty && s_saved_d3d9Device)
        {
            ...
            {
                if (SUCCEEDED(s_saved_d3d9Device
                                  ->GetBackBuffer(i, 0, D3DBACKBUFFER_TYPE_MONO, &pBackBuffer)))
                {
        ...
        for (std::map<IDirect3DTexture9*, IDirect3DTexture9_CustomData>::iterator iter =
                 texture9data.begin();
             iter != texture9data.end();
             iter++)
        {
        ...
        for (std::map<IDirect3DSurface9*, IDirect3DSurface9_CustomData>::iterator iter =
                 surface9data.begin();
             iter != surface9data.end();
             iter++)
        {
    ...
    bool RedrawScreenD3D9()
    {
        if (s_saved_d3d9Device)
        {
            ...
            if (s_saved_d3d9SwapChain)
                hr = s_saved_d3d9SwapChain->Present(s_savedD3D9pSrcRect,
                                                    pDstRect,
                                                    s_savedD3D9HWND,
                                                    NULL,
                                                    0);
            else
                hr = s_saved_d3d9Device->Present(s_savedD3D9pSrcRect,
                                                 pDstRect,
                                                 s_savedD3D9HWND,
                                                 NULL);
            return true;
...
#define HOOK(iface, name)                                     \
    ...
    protected:
        ...
        static HRESULT STDMETHODCALLTYPE
        MyCreateDevice(LPDIRECT3D9 thisptr,
                       UINT Adapter,
                       D3DDEVTYPE DeviceType,
                       HWND hFocusWindow,
                       DWORD BehaviorFlags,
    ...
    public:
        MyDirect3D9() : QueryInterface(nullptr), CreateDevice(nullptr)
        {
        }
    ...
    protected:
        ...
        static HRESULT STDMETHODCALLTYPE
        MyCreateDeviceEx(LPDIRECT3D9EX thisptr,
                         UINT Adapter,
                         D3DDEVTYPE DeviceType,
                         HWND hFocusWindow,
                         DWORD BehaviorFlags,
    ...
    public:
        MyDirect3D9Ex() : MyDirect3D9(), CreateDeviceEx(nullptr)
        {
        }
    ...
    void ApplyD3D9Intercepts()
    {
        static const InterceptDescriptor intercepts[] = {
            MAKE_INTERCEPT(1, D3D9, Direct3DCreate9), MAKE_INTERCEPT(1, D3D9, Direct3DCreate9Ex),
        };
