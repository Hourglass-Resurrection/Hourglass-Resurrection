...
static void Mix(const unsigned char* buf, unsigned char* outbuf, int myBitsPerSample, int outBitsPerSample, DWORD size, DWORD outSize, bool sizeReachesBufferEnd, Hooks::DirectSound::CachedVolumeAndPan& volumes)
{
